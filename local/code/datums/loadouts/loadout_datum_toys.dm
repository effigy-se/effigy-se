...
/datum/loadout_item/toys/abductor
	name = "Abductor Plushie"
	item_path = /obj/item/toy/plush/abductor

/datum/loadout_item/toys/abductor/agent
	name = "Abductor Agent Plushie"
	item_path = /obj/item/toy/plush/abductor/agent
