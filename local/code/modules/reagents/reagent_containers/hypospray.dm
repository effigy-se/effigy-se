...
/obj/item/hypospray/mkii/update_overlays()
	...
	var/mutable_appearance/chem_loaded = mutable_appearance('local/icons/obj/medical/hyposprays.dmi', vial_spritetype)
...
/obj/item/reagent_containers/cup/hypovial/update_overlays()
	...
	if(reagents.total_volume)
		...
		switch(round((reagents.total_volume / volume)*100))
			...
			if(89 to 100)
				fill_overlay = 100
		var/mutable_appearance/filling = mutable_appearance('local/icons/obj/medical/hypospray_fillings.dmi', "[fill_name][fill_overlay]")
