...
/obj/item/paper/shibari_kit_instructions
	default_raw_text = "Hello! Congratulations on your purchase of the shibari kit by LustWish! \
	Some newbies may get confused by our ropes, so we prepared a small instructions for you! \
	First of all, you have to have a wrench to construct the stand itself. \
	Secondly, you can use screwdrivers to change the color of your shibari stand. \
	Just replace the plastic fittings! Thirdly, if you want to tie somebody to a bondage stand you need to fully tie their body, on both groin and chest! \
	To do that you need to use rope on body and then on the groin of your submissive, then you can secure them to the stand. \
	Don't forget to have some ropes on your hand to actually tie them to the stand, as there's no ropes included with it! And that's it!"
