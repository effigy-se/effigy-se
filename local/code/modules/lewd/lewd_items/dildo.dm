...
/obj/item/clothing/sextoy/dildo/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound(loc, pick('local/sound/lewd/bang1.ogg',
						'local/sound/lewd/bang2.ogg',
						'local/sound/lewd/bang3.ogg',
						'local/sound/lewd/bang4.ogg',
						'local/sound/lewd/bang5.ogg',
						'local/sound/lewd/bang6.ogg'), 100, TRUE, ignore_walls = FALSE)
...
/obj/item/clothing/sextoy/dildo/double_dildo/proc/update_mob_action_buttonss()
	...
	if(istype(action_button, /datum/action/item_action/take_dildo))
		...
		action_button.button_icon = 'local/icons/obj/lewd_items/lewd_icons.dmi'
	update_icon()
...
/obj/item/clothing/sextoy/dildo/dildo_side
	...
	icon = 'local/icons/obj/lewd_items/lewd_icons.dmi'
