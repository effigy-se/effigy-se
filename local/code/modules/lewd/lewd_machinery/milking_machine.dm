...
/obj/structure/chair/milking_machine
	...
	icon = 'local/icons/obj/lewd_structures/milking_machine.dmi'
...
/obj/structure/chair/milking_machine/Initialize(mapload)
	...
	vessel_overlay = mutable_appearance('local/icons/obj/lewd_structures/milking_machine.dmi', "liquid_empty", LYING_MOB_LAYER)
	vessel_overlay.name = "vessel_overlay"
	indicator_overlay = mutable_appearance('local/icons/obj/lewd_structures/milking_machine.dmi', "indicator_empty", ABOVE_MOB_LAYER + 0.1)
	indicator_overlay.name = "indicator_overlay"
	locks_overlay = mutable_appearance('local/icons/obj/lewd_structures/milking_machine.dmi', "locks_open", BELOW_MOB_LAYER)
	locks_overlay.name = "locks_overlay"
	organ_overlay = mutable_appearance('local/icons/obj/lewd_structures/milking_machine.dmi', "none", ABOVE_MOB_LAYER)
