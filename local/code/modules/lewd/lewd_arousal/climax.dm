...
/mob/living/carbon/human/proc/climax(manual = TRUE)
	...
	switch(gender)
		if(MALE)
			cumsound = sound(pick(
				'local/sound/lewd/final_m1.ogg',
				'local/sound/lewd/final_m2.ogg',
				'local/sound/lewd/final_m3.ogg',
			))

		else
			cumsound = (pick(
				'local/sound/lewd/final_f1.ogg',
				'local/sound/lewd/final_f2.ogg',
				'local/sound/lewd/final_f3.ogg',
			))
