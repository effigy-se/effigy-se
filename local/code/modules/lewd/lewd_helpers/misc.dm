...
/datum/looping_sound/lewd/vibrator
	start_sound = 'local/sound/effects/lewd/bzzz-loop-1.ogg'
	start_length = 1
	mid_sounds = 'local/sound/effects/lewd/bzzz-loop-1.ogg'
	mid_length = 1
	end_sound = 'local/sound/effects/lewd/bzzz-loop-1.ogg'
	falloff_distance = 1
	falloff_exponent = 5
