/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	icon = 'local/icons/obj/lewd_clothing/lewd_suits.dmi'
	worn_icon = 'local/icons/mob/lewd_clothing/lewd_suit/sleepbag_normal.dmi'
	worn_icon_digi = 'local/icons/mob/lewd_clothing/lewd_suit/sleepbag_digi.dmi'
	worn_icon_taur_snake = 'local/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_paw = 'local/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_hoof = 'local/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/proc/fold(mob/user, src)
	bag_fold = !bag_fold
	playsound(user, 'local/sound/lewd/latex.ogg', 40, TRUE, ignore_walls = FALSE)
	if(bag_fold == TRUE)
		w_class = WEIGHT_CLASS_SMALL
		slot_flags = NONE
	if(bag_fold == FALSE)
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/process(seconds_per_tick)
	if(time_to_sound_left <= 0)
		if(tt <= 0)
			playsound(loc, 'local/sound/lewd/latex.ogg', 100, TRUE, ignore_walls = FALSE)
