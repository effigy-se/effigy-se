/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	worn_icon_taur_snake = 'local/icons/lewd/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_paw = 'local/icons/lewd/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_hoof = 'local/icons/lewd/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/process(seconds_per_tick)
	if(time_to_sound_left <= 0)
		if(tt <= 0)
			play_lewd_sound(loc, 'local/sound/effects/lewd/latex.ogg', 100, TRUE)
