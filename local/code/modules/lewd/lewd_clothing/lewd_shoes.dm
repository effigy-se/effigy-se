...
/obj/item/clothing/shoes/latex_heels
	...
	icon = 'local/icons/obj/lewd_clothing/lewd_shoes.dmi'
	worn_icon = 'local/icons/mob/lewd_clothing/lewd_shoes.dmi'
	worn_icon_digi = 'local/icons/mob/lewd_clothing/lewd_shoes_digi.dmi'
	worn_icon_taur_hoof = 'local/icons/obj/lewd_clothing/lewd_shoes.dmi'
	worn_icon_taur_paw = 'local/icons/obj/lewd_clothing/lewd_shoes.dmi'
	worn_icon_taur_snake = 'local/icons/obj/lewd_clothing/lewd_shoes.dmi'
...
/obj/item/clothing/shoes/latex_heels/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/squeak, list('local/sound/lewd/highheel1.ogg' = 1, 'local/sound/lewd/highheel2.ogg' = 1), 70)
