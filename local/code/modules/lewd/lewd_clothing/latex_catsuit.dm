/obj/item/clothing/under/misc/latex_catsuit
	...
	icon = 'local/icons/obj/lewd_clothing/lewd_uniform.dmi'
	worn_icon = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_digi = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform-digi.dmi'
	worn_icon_taur_snake = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform-snake.dmi'
	worn_icon_taur_paw = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform-paw.dmi'
	worn_icon_taur_hoof = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform-hoof.dmi'
	...
	equip_sound = 'local/sound/lewd/latex.ogg'
	can_adjust = FALSE
	strip_delay = 80
...
/obj/item/clothing/under/misc/latex_catsuit/equipped(mob/living/affected_mob, slot)
	...
	breasts_overlay = mutable_appearance('local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi', "none")
	update_overlays()
...
/obj/item/clothing/under/misc/latex_catsuit/Initialize(mapload)
	. = ..()
	breasts_overlay = mutable_appearance('local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi', "none", ABOVE_MOB_LAYER)
	breasts_overlay.icon_state = ORGAN_SLOT_BREASTS
	breasts_icon_overlay = mutable_appearance('local/icons/obj/lewd_clothing/lewd_uniform.dmi', "none")
