/obj/item/clothing/under/misc/latex_catsuit
	...
	equip_sound = 'local/sound/effects/lewd/latex.ogg'
	can_adjust = FALSE
	strip_delay = 80
...
/obj/item/clothing/under/misc/latex_catsuit/equipped(mob/living/affected_mob, slot)
	...
	breasts_overlay = mutable_appearance('local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi', "none")
	update_overlays()
...
/obj/item/clothing/under/misc/latex_catsuit/Initialize(mapload)
	. = ..()
	breasts_overlay = mutable_appearance('local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi', "none", ABOVE_MOB_LAYER)
	breasts_overlay.icon_state = ORGAN_SLOT_BREASTS
	breasts_icon_overlay = mutable_appearance('local/icons/lewd/obj/lewd_clothing/lewd_uniform.dmi', "none")
