/obj/item/clothing/under/costume/lewdmaid
	...
	worn_icon_digi = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_snake = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_paw = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_hoof = 'local/icons/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
...
/obj/item/clothing/accessory/lewdapron
	...
	worn_icon = 'local/icons/mob/lewd_items/lewd_items.dmi'
...
/obj/item/clothing/under/costume/lewdmaid/attach_accessory(obj/item/attack_item)
	...
	accessory_overlay = mutable_appearance('local/icons/mob/lewd_items/lewd_items.dmi', "[accessory_color]", ABOVE_MOB_LAYER + 0.1)
