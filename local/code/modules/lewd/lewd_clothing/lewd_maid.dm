/obj/item/clothing/under/costume/lewdmaid
	...
	worn_icon_digi = 'local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_snake = 'local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_paw = 'local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_hoof = 'local/icons/lewd/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
...
/obj/item/clothing/under/costume/lewdmaid/attach_accessory(obj/item/attack_item)
	...
	accessory_overlay = mutable_appearance('local/icons/lewd/mob/lewd_items/lewd_items.dmi', "[accessory_color]", ABOVE_MOB_LAYER + 0.1)
