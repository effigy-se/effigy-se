/obj/structure/chair/shibari_stand
	...
	icon = 'local/icons/obj/lewd_structures/shibari_stand.dmi'
	...
	var/static/mutable_appearance/shibari_shadow_overlay = mutable_appearance('local/icons/obj/lewd_structures/shibari_stand.dmi', "shibari_shadow", LOW_OBJ_LAYER)
