...
/obj/structure/chair/x_stand
	...
	var/static/mutable_appearance/xstand_overlay = mutable_appearance('local/icons/lewd/obj/lewd_structures/bdsm_furniture.dmi', "xstand_overlay", LYING_MOB_LAYER)
