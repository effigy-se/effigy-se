...
/obj/item/clothing/shoes/colorable_laceups
	...
	icon = 'local/icons/mob/clothing/greyscale/shoes/shoes.dmi'
	worn_icon = 'local/icons/mob/clothing/greyscale/shoes/shoes.dmi'
	worn_icon_teshari = 'local/icons/mob/clothing/greyscale/shoes/shoes_teshari.dmi'
	icon_state = "laceups"
