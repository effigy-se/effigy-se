/obj/item/clothing/head/costume/skyrat
	icon = 'packages/clothing/assets/obj/head/costume.dmi'
	worn_icon = 'packages/clothing/assets/mob/head/costume.dmi'
...
/obj/item/clothing/head/pelt/wolf
	...
	worn_icon = 'packages/clothing/assets/mob/head/pelt_big.dmi'
