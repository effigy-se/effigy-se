...
/obj/item/clothing/head/bio_hood
	worn_icon_muzzled = 'packages/clothing/assets/mob/head/bio_muzzled.dmi'

/obj/item/clothing/head/helmet/space
	worn_icon_muzzled = 'packages/clothing/assets/mob/head/spacehelm_muzzled.dmi'
...
/obj/item/clothing/head/helmet/chaplain
	worn_icon_muzzled = 'packages/clothing/assets/mob/head/chaplain_muzzled.dmi'
