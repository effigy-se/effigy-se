...
/obj/item/clothing/head/bio_hood
	worn_icon_muzzled = 'local/icons/mob/clothing/head/bio_muzzled.dmi'

/obj/item/clothing/head/helmet/space
	worn_icon_muzzled = 'local/icons/mob/clothing/head/spacehelm_muzzled.dmi'
...
/obj/item/clothing/head/helmet/chaplain
	worn_icon_muzzled = 'local/icons/mob/clothing/head/chaplain_muzzled.dmi'
