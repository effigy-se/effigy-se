/obj/item/clothing/under/rank/civilian
	worn_icon_digi = 'local/icons/mob/clothing/under/civilian_digi.dmi' //Anything that was in TG's civilian.dmi, should be in our civilian_digi.dmi
...
/obj/item/clothing/under/rank/civilian/lawyer/beige	//Some FOOL upstream has this item's worn and object icons seperate. This sucks.
	worn_icon_digi = 'local/icons/mob/clothing/under/suits_digi.dmi'

/obj/item/clothing/under/rank/civilian/head_of_personnel/skyrat
	icon = 'local/icons/obj/clothing/under/civilian.dmi'
	worn_icon = 'local/icons/mob/clothing/under/civilian.dmi'
