/obj/item/clothing/under/rank/captain
	worn_icon_digi = 'local/icons/mob/clothing/under/command_digi.dmi' //Anything that was in TG's captain.dmi, should be in our command_digi.dmi
...
/obj/item/clothing/under/rank/captain/skyrat
	icon = 'local/icons/obj/clothing/under/command.dmi'
	worn_icon = 'local/icons/mob/clothing/under/command.dmi'
...
/obj/item/clothing/under/rank/blueshield
	icon = 'local/icons/obj/clothing/under/command.dmi'
	worn_icon = 'local/icons/mob/clothing/under/command.dmi'
	worn_icon_digi = 'local/icons/mob/clothing/under/command_digi.dmi'
