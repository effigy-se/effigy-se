/obj/item/clothing/under/rank/medical
	worn_icon_digi = 'local/icons/mob/clothing/under/medical_digi.dmi'	// Anything that was in the medical.dmi, should be in the medical_digi.dmi

/obj/item/clothing/under/rank/medical/doctor/skyrat
	icon = 'local/icons/obj/clothing/under/medical.dmi'
	worn_icon = 'local/icons/mob/clothing/under/medical.dmi'
