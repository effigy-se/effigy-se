...
/obj/item/clothing/suit/hooded/wintercoat/skyrat
	...
	icon = 'local/icons/obj/clothing/suits/wintercoat.dmi'
	worn_icon = 'local/icons/mob/clothing/suits/wintercoat.dmi'
...
/obj/item/clothing/head/hooded/winterhood/skyrat
	icon = 'local/icons/obj/clothing/head/winterhood.dmi'
	worn_icon = 'local/icons/mob/clothing/head/winterhood.dmi'
