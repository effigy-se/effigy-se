...
/obj/item/organ/external/snout
	...
	external_bodytypes = NONE // We don't actually want this to have BODYSHAPE_SNOUTED by default, since some of them don't apply that.
...
/obj/item/organ/external/snout/Insert(mob/living/carbon/reciever, special, movement_flags)
	if(sprite_accessory_flags & SPRITE_ACCESSORY_USE_MUZZLED_SPRITE)
		external_bodytypes |= BODYSHAPE_SNOUTED
