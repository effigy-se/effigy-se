...
/datum/sprite_accessory/snouts/vox
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/vox_snouts.dmi'
...
/datum/sprite_accessory/hair/vox
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/vox_hair.dmi'
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/facial_hair/vox
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/vox_facial_hair.dmi'
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/tails/vox
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/vox_tails.dmi'
	name = "Vox Tail"
	icon_state = "vox"
	recommended_species = list(SPECIES_VOX)
...
/datum/sprite_accessory/spines/vox
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/vox_spines.dmi'
