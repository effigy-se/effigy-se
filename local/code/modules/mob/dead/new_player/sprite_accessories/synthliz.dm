...
/datum/sprite_accessory/snouts/synthliz
	...
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/synthliz_snouts.dmi'
...
/datum/sprite_accessory/tails/synthliz
	recommended_species = list()
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/synthliz_tails.dmi'
	color_src = USE_ONE_COLOR
...
/datum/sprite_accessory/antenna/synthliz
	icon = 'local/icons/obj/mob/mutant/mutant_accessories/synthliz_antennas.dmi'
	color_src = USE_ONE_COLOR
