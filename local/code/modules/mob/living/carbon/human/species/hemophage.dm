...
/obj/item/organ/internal/heart/hemophage
	...
	icon = 'local/icons/obj/medical/organs/hemophage_organs.dmi'
	icon_state = "tumor-on"
...
/obj/item/organ/internal/liver/hemophage/proc/handle_drink(mob/living/target_mob, obj/item/reagent_containers/cup/container, mob/living/user)
	...
	if(container.reagents.has_expanded_chemical_flag(REAGENT_BLOOD_REGENERATING, container.reagents.total_volume * MINIMUM_BLOOD_REGENING_REAGENT_RATIO)) // At least 75% of the content of the cup needs to be something that's counting as blood-regenerating for the tumor not to freak out.
		return
