...
/datum/blooper/chitter
	...
	soundpath = 'local/sound/voice/bloopers/chitter.ogg'
...
/datum/blooper/moff/short
	name = "Moff squeak"
	id = "moffsqueak"
	soundpath = 'local/sound/voice/bloopers/mothsqueak.ogg'
	allow_random = TRUE
	ignore = FALSE
...
/datum/blooper/meow //Meow blooper?
	...
	id = "meow"
	allow_random = TRUE
	soundpath = 'local/sound/voice/bloopers/meow1.ogg'
	minspeed = 5
	maxspeed = 11
...
/datum/blooper/chirp
	...
	id = "chirp"
	allow_random = TRUE
	soundpath = 'local/sound/voice/bloopers/chirp.ogg'

/datum/blooper/caw
	name = "Caw"
	id = "caw"
	allow_random = TRUE
	soundpath = 'local/sound/voice/bloopers/caw.ogg'

//Undertale
/datum/blooper/alphys
	name = "Alphys"
	id = "alphys"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_alphys.ogg'
	minvariance = 0

/datum/blooper/asgore
	name = "Asgore"
	id = "asgore"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_asgore.ogg'
	minvariance = 0

/datum/blooper/flowey
	name = "Flowey (normal)"
	id = "flowey1"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_flowey_1.ogg'
	minvariance = 0

/datum/blooper/flowey/evil
	name = "Flowey (evil)"
	id = "flowey2"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_flowey_2.ogg'
	minvariance = 0

/datum/blooper/papyrus
	name = "Papyrus"
	id = "papyrus"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_papyrus.ogg'
	minvariance = 0

/datum/blooper/ralsei
	name = "Ralsei"
	id = "ralsei"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_ralsei.ogg'
	minvariance = 0

/datum/blooper/sans //real
	name = "Sans"
	id = "sans"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_sans.ogg'
	minvariance = 0

/datum/blooper/toriel
	name = "Toriel"
	id = "toriel"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_toriel.ogg'
	minvariance = 0
...
/datum/blooper/undyne
	name = "Undyne"
	id = "undyne"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_undyne.ogg'
	minvariance = 0

/datum/blooper/temmie
	name = "Temmie"
	id = "temmie"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_temmie.ogg'
	minvariance = 0

/datum/blooper/susie
	name = "Susie"
	id = "susie"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_susie.ogg'
	minvariance = 0
...
/datum/blooper/mettaton
	name = "Mettaton"
	id = "mettaton"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_metta_1.ogg'
	minvariance = 0

/datum/blooper/gen_monster
	name = "Generic Monster 1"
	id = "gen_monster_1"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_monster1.ogg'
	minvariance = 0

/datum/blooper/gen_monster/alt
	name = "Generic Monster 2"
	id = "gen_monster_2"
	soundpath = 'local/sound/voice/bloopers/undertale/voice_monster2.ogg'
	minvariance = 0

/datum/blooper/wilson
	name = "Wilson"
	id = "wilson"
	soundpath = 'local/sound/voice/bloopers/dont_starve/wilson_blooper.ogg'

/datum/blooper/wolfgang
	name = "Wolfgang"
	id = "wolfgang"
	soundpath = 'local/sound/voice/bloopers/dont_starve/wolfgang_blooper.ogg'
	minspeed = 4
	maxspeed = 10
...
/datum/blooper/woodie
	name = "Woodie"
	id = "woodie"
	soundpath = 'local/sound/voice/bloopers/dont_starve/woodie_blooper.ogg'
	minspeed = 4
	maxspeed = 10
...
/datum/blooper/wurt
	name = "Wurt"
	id = "wurt"
	soundpath = 'local/sound/voice/bloopers/dont_starve/wurt_blooper.ogg'

/datum/blooper/wx78
	name = "wx78"
	id = "wx78"
	soundpath = 'local/sound/voice/bloopers/dont_starve/wx78_blooper.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/chitter/alt
	name = "Chittery Alt"
	id = "chitter2"
	soundpath = 'local/sound/voice/bloopers/moth/mothchitter2.ogg'

// The Mayhem Special
/datum/blooper/whistle
	name = "Whistle 1"
	id = "whistle1"
	soundpath = 'local/sound/voice/bloopers/kazooie/birdwhistle.ogg'

/datum/blooper/whistle/alt1
	name = "Whistle 2"
	id = "whistle2"
	soundpath = 'local/sound/voice/bloopers/kazooie/birdwhistle2.ogg'

/datum/blooper/caw/alt1
	name = "Caw 2"
	id = "caw2"
	soundpath = 'local/sound/voice/bloopers/kazooie/caw.ogg'
	minspeed = 4
	maxspeed = 9
...
/datum/blooper/caw/alt2
	name = "Caw 3"
	id = "caw3"
	soundpath = 'local/sound/voice/bloopers/kazooie/caw2.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/caw/alt3
	name = "Caw 4"
	id = "caw4"
	soundpath = 'local/sound/voice/bloopers/kazooie/caw3.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/ehh
	name = "Ehh 1"
	id = "ehh1"
	soundpath = 'local/sound/voice/bloopers/kazooie/ehh.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/ehh/alt1
	name = "Ehh 2"
	id = "ehh2"
	soundpath = 'local/sound/voice/bloopers/kazooie/ehh2.ogg'

/datum/blooper/ehh/alt2
	name = "Ehh 3"
	id = "ehh3"
	soundpath = 'local/sound/voice/bloopers/kazooie/ehh3.ogg'

/datum/blooper/ehh/alt3
	name = "Ehh 4"
	id = "ehh4"
	soundpath = 'local/sound/voice/bloopers/kazooie/ehh4.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/ehh/alt5
	name = "Ehh 5"
	id = "ehh5"
	soundpath = 'local/sound/voice/bloopers/kazooie/ehh5.ogg'

/datum/blooper/faucet
	name = "Faucet 1"
	id = "faucet1"
	soundpath = 'local/sound/voice/bloopers/kazooie/faucet.ogg'

/datum/blooper/faucet/alt1
	name = "Faucet 2"
	id = "faucet2"
	soundpath = 'local/sound/voice/bloopers/kazooie/faucet2.ogg'

/datum/blooper/ribbit
	name = "Ribbit"
	id = "ribbit"
	soundpath = 'local/sound/voice/bloopers/kazooie/ribbit.ogg'

/datum/blooper/hoot
	name = "Hoot"
	id = "hoot"
	soundpath = 'local/sound/voice/bloopers/kazooie/hoot.ogg'
	minspeed = 4
	maxspeed = 9
...
/datum/blooper/tweet
	name = "Tweet"
	id = "tweet"
	soundpath = 'local/sound/voice/bloopers/kazooie/tweet.ogg'

/datum/blooper/dwoop
	name = "Dwoop"
	id = "dwoop"
	soundpath = 'local/sound/voice/bloopers/kazooie/dwoop.ogg'
	minspeed = 3
	maxspeed = 9
...
/datum/blooper/uhm
	name = "Uhm"
	id = "uhm"
	soundpath = 'local/sound/voice/bloopers/kazooie/uhm.ogg'

/datum/blooper/wurtesh
	name = "Wurtesh"
	id = "wurtesh"
	soundpath = 'local/sound/voice/bloopers/kazooie/wurble1.ogg'

/datum/blooper/chitter2
	name = "Chitter2"
	id = "chitter2"
	soundpath = 'local/sound/voice/bloopers/kazooie/chitter1.ogg'
