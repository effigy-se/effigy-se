...
/obj/item/organ/internal/cyberimp/brain/nif
	...
	var/good_sound ='local/code/modules/modular_implants/sounds/default_good.ogg'
	///This is the sound that plays if there is an issue going on.
	var/bad_sound = 'local/code/modules/modular_implants/sounds/default_bad.ogg'
	///This is the sound that you would hear if you enable if you activate or enable something.
	var/click_sound = 'local/code/modules/modular_implants/sounds/default_click.ogg'
	///What icon does the NIF display in chat when sending out alerts? Icon states are stored in 'local/code/modules/modular_implants/icons/chat.dmi'
...
/obj/item/organ/internal/cyberimp/brain/nif/proc/send_message(message_to_send, alert = FALSE)
	...
	to_chat(linked_mob, span_blue("[nif_icon] <b>NIF Message</b>: [message_to_send]"))
...
/datum/asset/spritesheet/chat/create_spritesheets()
	...
	InsertAll("nif", 'local/icons/hud/chat.dmi')
