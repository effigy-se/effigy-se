...
/datum/component/soulcatcher/proc/scan_body(mob/living/parent_body, mob/living/user)
	...
	if(istype(parent, /obj/item/handheld_soulcatcher))
		...
		playsound(parent_device, 'local/code/modules/modular_implants/sounds/default_good.ogg', 50, FALSE, ignore_walls = FALSE)
...
/datum/soulcatcher_room/proc/add_soul(datum/mind/mind_to_add)
	...
	to_chat(new_soul, span_blue("You find yourself now inside of: [name]"))
	to_chat(new_soul, span_notice(room_description))
	to_chat(new_soul, span_danger("You have entered a soulcatcher, do not share any information you have received while a ghost. If you have died within the round, you do not know your identity until your body has been scanned, standard blackout policy also applies."))
...
/datum/soulcatcher_room/proc/transfer_soul(mob/living/soulcatcher_soul/target_soul, datum/soulcatcher_room/target_room)
	...
	to_chat(target_soul, span_blue("you've been transfered to [target_room]!"))
