...
CREATE TABLE `player` (
  ...
  `flags` smallint(5) unsigned DEFAULT '0' NOT NULL,
	`age_verification_status` tinyint(3) unsigned DEFAULT 0,
  `verifying_admin` varchar(32) DEFAULT NULL,
  `verifying_datetime` datetime DEFAULT NULL,
  PRIMARY KEY (`ckey`),
