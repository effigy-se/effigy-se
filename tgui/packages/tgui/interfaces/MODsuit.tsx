...
type SuitStatus = {
  ...
  ai_name: string;
  pAI: string; // EFFIGY EDIT ADDITION - pAIs in MODsuits
  ispAI: BooleanLike; // EFFIGY EDIT ADDITION - pAIs in MODsuits
};
  ...
  return (
    <Section
      ...
      <LabeledList>
        ...
        {/* EFFIGY EDIT START - pAIs in MODsuits*/}
...
const HardwareSection = (props, context) => {
  ...
  const { pAI, core_name } = data.suit_status; /* EFFIGY EDIT CHANGE - pAI */
  return (
    <Section title="Hardware" style={{ 'text-transform': 'capitalize' }}>
      <LabeledList>
        <LabeledList.Item label="pAI Card" /* EFFIGY EDIT CHANGE - pAI */>
          {pAI || 'No pAI Card Detected' /* EFFIGY EDIT CHANGE - pAI */}
        </LabeledList.Item>
