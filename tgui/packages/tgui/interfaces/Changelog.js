  ...
  render() {
    ...
    const header = (
      <Section>
        ...
        <p>
          <b>Thanks to: </b>
          /tg/station, Skyrat Station, Baystation 12, /vg/station, NTstation,
          ...
          countless others who have contributed to the game, issue tracker or
          wiki over the years.
        </p>
        <p>
    ...
    const footer = (
      <Section>
        ...
        <p>
          Effigy Space Station 13 is thankful to the GoonStation 13 Development
        ...
        <h3>Effigy Space Station 13 License</h3>
        <p>
          {'All code after '}
          <a
            href={
