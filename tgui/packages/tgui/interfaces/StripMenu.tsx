...
const ROWS = 6; // EFFIGY EDIT CHANGE (#3 Customization - Ported from Skyrat)
const COLUMNS = 6;
...
const ALTERNATE_ACTIONS: Record<string, AlternateAction> = {
  ...
  enable_internals: {
    icon: 'lungs', // EFFIGY EDIT CHANGE (#3 Customization - Ported from Skyrat) TGFONT IS FUCKED AND I DUNNO WHY SO HERE'S A BANDAID - original "tg-air-tank"
    text: 'Enable internals',
  },

  disable_internals: {
    icon: 'lungs-virus', // EFFIGY EDIT CHANGE (#3 Customization - Ported from Skyrat) TGFONT IS FUCKED AND I DUNNO WHY SO HERE'S A BANDAID - original "tg-air-tank-slash"
