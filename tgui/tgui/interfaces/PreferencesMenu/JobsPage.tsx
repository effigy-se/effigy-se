...
const PriorityButtons = (props: {
  ...
  return (
    <Box
      inline // EFFIGY EDIT CHANGE
      style={{
        'align-items': 'center',
        'height': '100%',
        'textAlign': 'end', // EFFIGY EDIT CHANGE
        'padding': '0.3em', // EFFIGY EDIT CHANGE
      }}>
      {isOverflow ? (
        <>
          <PriorityButton
...
const JobRow = (
  ...
  return (
    <Box
      ...
      <Stack align="center" /* EFFIGY EDIT CHANGE */>
        <Tooltip
          content={job.description}
          position="right" // EFFIGY EDIT CHANGE bottom-start->right
        >
          <Stack.Item
            className="job-name"
            width="50%"
        ...
        <Stack.Item width="50%" className="options" /* EFFIGY EDIT CHANGE */>
          {rightSide}
        </Stack.Item>
      </Stack>
    </Box> // EFFIGY EDIT CHANGE
