...
export const QuirksPage = (props, context) => {
  ...
  return (
    <ServerPreferencesFetcher
      // EFFIGY EDIT CHANGE START - Quirks balance refactor
      render={(quirks_data) => {
        if (!quirks_data) {
        ...
        } = quirks_data.quirks; // EFFIGY EDIT CHANGE - Quirks balance refactor
        ...
        // EFFIGY EDIT CHANGE START - Better Quirk Count Code
