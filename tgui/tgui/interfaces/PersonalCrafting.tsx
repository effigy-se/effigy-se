...
const TYPE_ICONS = {
  ...
  [Food.Bloody]: 'tint', // EFFIGY EDIT ADD - Hemophage Food
  [Food.Breakfast]: 'sun',
  [Food.Bugs]: 'bug',
  [Food.Cloth]: 'tshirt',
  [Food.Dairy]: 'cheese',
...
const CATEGORY_ICONS_COOKING = {
  ...
  'Egg-Based Food': 'egg',
  'Frozen': 'ice-cream',
  'Hemophage Food': 'tint', // EFFIGY EDIT ADD - Hemophage Food
  'Lizard Food': 'dragon',
  'Meats': 'bacon',
  ...
  'Teshari Food': 'feather-pointed', // EFFIGY EDIT ADD - Teshari Food
} as const;
