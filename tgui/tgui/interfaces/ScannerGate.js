...
const TARGET_SPECIES_LIST = [
  ...
  //  EFFIGY EDIT ADD START - MORE SCANNER GATE OPTIONS
  {
    name: 'Anthromorph',
    value: 'mammal',
  },
...
const TARGET_GENDER_LIST = [
  ...
  //  EFFIGY EDIT ADD END - MORE SCANNER GATE OPTIONS
];
  ...
  return (
    <>
      ...
      <Box>
        ...
        />
        <Button //  EFFIGY EDIT ADD START - MORE SCANNER GATE OPTIONS
          content="Gender"
          onClick={() => act('set_mode', { new_mode: 'Gender' })} //  EFFIGY EDIT ADD END - MORE SCANNER GATE OPTIONS
        />
        <Button
          content="Nutrition"
