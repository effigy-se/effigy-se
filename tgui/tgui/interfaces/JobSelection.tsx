...
type Data = {
  ...
  alert_level: { name: string; color: string }; // EFFIGY EDIT ADD - Alert level on jobs menu
};
  ...
  return (
    <Window
      ...
      height={
        data.shuttle_status
          ? 916
          : 900 /* Hahahahahaha */ /* EFFIGY EDIT - Expand UI for available jobs - ORIGINAL: data.shuttle_status ? 690 : 666 */
      }
      onComponentDidMount={() => {
        ...
        <StyleableSection
          title={
            <>
              ...
              {
                // EFFIGY EDIT ADD - Alert level on jobs menu
