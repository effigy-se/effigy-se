...
/datum/greyscale_config/beret
	name = "Beret"
	icon_file = 'packages/greyscale/assets/beret.dmi'
	json_config = 'packages/greyscale/json_configs/beret/beret.json'

/datum/greyscale_config/beret/worn
	name = "Beret Worn"
	json_config = 'packages/greyscale/json_configs/beret/beret_worn.json'
...
/datum/greyscale_config/beret_badge
	...
	icon_file = 'packages/greyscale/assets/beret.dmi'
	json_config = 'packages/greyscale/json_configs/beret/beret_badge.json'

/datum/greyscale_config/beret_badge/worn
	name = "Beret With Badge Worn"
	json_config = 'packages/greyscale/json_configs/beret/beret_badge_worn.json'
...
/datum/greyscale_config/beret_badge_fancy
	...
	icon_file = 'packages/greyscale/assets/beret.dmi'
	json_config = 'packages/greyscale/json_configs/beret/beret_badge_fancy.json'

/datum/greyscale_config/beret_badge_fancy/worn
	name = "Beret With Fancy Badge Worn"
	json_config = 'packages/greyscale/json_configs/beret/beret_badge_fancy_worn.json'
...
/datum/greyscale_config/cowboy_wide
	...
	icon_file = 'packages/clothing/assets/obj/head/cowboy.dmi'
	json_config = 'packages/greyscale/json_configs/head/cowboy/two_layer_hats.json'

/datum/greyscale_config/cowboy_wide/worn
	name = "Wide Brimmed Hat (Worn)"
	icon_file = 'packages/clothing/assets/mob/head/cowboy.dmi'

/datum/greyscale_config/cowboy_wide_feathered
	name = "Wide Brimmed Feathered Hat"
	icon_file = 'packages/clothing/assets/obj/head/cowboy.dmi'
	json_config = 'packages/greyscale/json_configs/head/cowboy/three_layer_hats.json'
...
/datum/greyscale_config/mushcap
	name = "Mushroom Cap"
	icon_file = 'packages/greyscale/assets/mushcap.dmi'
	json_config = 'packages/greyscale/json_configs/mush_cap/mushcap.json'

/datum/greyscale_config/mushcap/worn
	name = "Mushroom Cap Worn"
	json_config = 'packages/greyscale/json_configs/mush_cap/mushcap_worn.json'

// FLATCAP

/datum/greyscale_config/flatcap
	name = "Flat Cap"
	icon_file = 'packages/greyscale/assets/hats.dmi'
	json_config = 'packages/greyscale/json_configs/flatcap/flatcap.json'

/datum/greyscale_config/flatcap/worn
	name = "Flat Cap (Worn)"
	icon_file = 'packages/greyscale/assets/hats.dmi'
	json_config = 'packages/greyscale/json_configs/flatcap/flatcap_worn.json'
...
/datum/greyscale_config/flowerpin
	name = "Flower Pin"
	icon_file = 'packages/greyscale/assets/hats.dmi'
	json_config = 'packages/greyscale/json_configs/flowerpin/flowerpin.json'

/datum/greyscale_config/flowerpin/worn
	name = "Flower Pin (Worn)"
	icon_file = 'packages/greyscale/assets/hats.dmi'
	json_config = 'packages/greyscale/json_configs/flowerpin/flowerpin_worn.json'

// Hood

/datum/greyscale_config/standalone_hood
	name = "Hood"
	icon_file = 'packages/greyscale/assets/head/head.dmi'
	json_config = 'packages/greyscale/json_configs/head/hood/hood.json'

/datum/greyscale_config/standalone_hood/worn
	name = "Hood (Worn)"
	json_config = 'packages/greyscale/json_configs/head/hood/hood_worn.json'

/datum/greyscale_config/standalone_hood/worn/teshari
	icon_file = 'packages/greyscale/assets/head/head_teshari.dmi'

/datum/greyscale_config/standalone_hood/worn/newvox
	icon_file = 'packages/greyscale/assets/head/head_newvox.dmi'

/datum/greyscale_config/standalone_hood/worn/oldvox
	icon_file = 'packages/greyscale/assets/head/head_oldvox.dmi'
...
/datum/greyscale_config/clown_mask
	...
	icon_file = 'packages/greyscale/assets/clown_mask.dmi'
	json_config = 'packages/greyscale/json_configs/clown_mask/clown_mask.json'

/datum/greyscale_config/clown_mask/worn
	name = "Colourable Clown Mask (Worn)"
	json_config = 'packages/greyscale/json_configs/clown_mask/clown_mask_worn.json'

// VAPE
/datum/greyscale_config/vape/worn/digi
	name = "Worn Vape - Digitigrade"
	icon_file = 'packages/clothing/assets/mob/mask.dmi'

// RESPIRATOR
/datum/greyscale_config/respirator
	name = "Colourable Respirator"
	icon_file = 'packages/greyscale/assets/masks.dmi'
	json_config = 'packages/greyscale/json_configs/respirator/respirator.json'

/datum/greyscale_config/respirator/worn
	name = "Colourable Respirator (Worn)"
	json_config = 'packages/greyscale/json_configs/respirator/respirator_worn.json'

/datum/greyscale_config/respirator/worn/snouted
	name = "Colourable Respirator (Worn) (Snouted)"
	icon_file = 'packages/greyscale/assets/masks_snout.dmi'

/datum/greyscale_config/respirator/worn/better_vox
	name = "Colourable Respirator (Worn) (Vox Primalis)"
	icon_file = 'packages/greyscale/assets/masks_vox_better.dmi'

/datum/greyscale_config/respirator/worn/vox
	name = "Colourable Respirator (Worn) (Vox)"
	icon_file = 'packages/greyscale/assets/masks_vox.dmi'

/datum/greyscale_config/respirator/worn/teshari
	name = "Colourable Respirator (Worn) (Teshari)"
	icon_file = 'packages/greyscale/assets/masks_teshari.dmi'

// STERILE
/datum/greyscale_config/sterile_mask
	name = "Colourable Sterile Mask"
	icon_file = 'packages/greyscale/assets/masks.dmi'
	json_config = 'packages/greyscale/json_configs/sterile_mask/sterile.json'

/datum/greyscale_config/sterile_mask/worn
	name = "Colourable Sterile Mask (Worn)"
	json_config = 'packages/greyscale/json_configs/sterile_mask/sterile_worn.json'
...
/datum/greyscale_config/ranger_poncho
	name = "Ranger Poncho"
	icon_file = 'packages/greyscale/assets/ranger_poncho.dmi'
	json_config = 'packages/greyscale/json_configs/ranger_poncho/ranger_poncho.json'

/datum/greyscale_config/ranger_poncho/worn
	name = "Ranger Poncho Worn"
	json_config = 'packages/greyscale/json_configs/ranger_poncho/ranger_poncho_worn.json'

/datum/greyscale_config/ranger_poncho/worn/teshari
	name = "Ranger Poncho Worn - Teshari"
	icon_file = 'packages/greyscale/assets/ranger_poncho_teshari.dmi'

// CLOAKS
/datum/greyscale_config/cloak
	name = "Cloak"
	icon_file = 'packages/greyscale/assets/cloak.dmi'
	json_config = 'packages/greyscale/json_configs/cloak/cloak.json'

/datum/greyscale_config/cloak/worn
	name = "Cloak Worn"
	json_config = 'packages/greyscale/json_configs/cloak/cloak_worn.json'

/datum/greyscale_config/cloak/veil
	name = "Veil"
	json_config = 'packages/greyscale/json_configs/cloak/veil.json'

/datum/greyscale_config/cloak/veil/worn
	name = "Veil Worn"
	json_config = 'packages/greyscale/json_configs/cloak/veil_worn.json'

/datum/greyscale_config/cloak/boat
	name = "Boatcloak"
	json_config = 'packages/greyscale/json_configs/cloak/boat.json'

/datum/greyscale_config/cloak/boat/worn
	name = "Boatcloak Worn"
	json_config = 'packages/greyscale/json_configs/cloak/boat_worn.json'

/datum/greyscale_config/cloak/shroud
	name = "Shroud"
	json_config = 'packages/greyscale/json_configs/cloak/shroud.json'

/datum/greyscale_config/cloak/shroud/worn
	name = "Shroud Worn"
	json_config = 'packages/greyscale/json_configs/cloak/shroud_worn.json'

// Mantle

/datum/greyscale_config/mantle
	name = "Mantle"
	icon_file = 'packages/greyscale/assets/neck/neck.dmi'
	json_config = 'packages/greyscale/json_configs/neck/mantle/mantle.json'

/datum/greyscale_config/mantle/worn
	name = "Mantle (Worn)"
	json_config = 'packages/greyscale/json_configs/neck/mantle/mantle_worn.json'

/datum/greyscale_config/mantle/worn/teshari
	icon_file = 'packages/greyscale/assets/neck/neck_teshari.dmi'

/datum/greyscale_config/mantle/worn/newvox
	icon_file = 'packages/greyscale/assets/neck/neck_newvox.dmi'

/datum/greyscale_config/mantle/worn/oldvox
	icon_file = 'packages/greyscale/assets/neck/neck_oldvox.dmi'

// COLLARS

/datum/greyscale_config/collar
	name = "Collar"
	icon_file = 'packages/greyscale/assets/collar.dmi'
	json_config = 'packages/greyscale/json_configs/collar/bell.json'
...
/datum/greyscale_config/collar/bell/worn
	...
	json_config = 'packages/greyscale/json_configs/collar/bell_worn.json'

// Choker
/datum/greyscale_config/collar/choker
	name = "Choker"
	json_config = 'packages/greyscale/json_configs/collar/choker.json'

/datum/greyscale_config/collar/choker/worn
	name = "Choker (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/choker_worn.json'

// Cow
/datum/greyscale_config/collar/cow
	name = "Cowbell Collar"
	json_config = 'packages/greyscale/json_configs/collar/cow.json'

/datum/greyscale_config/collar/cow/worn
	name = "Cowbell Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/cow_worn.json'

// Cross
/datum/greyscale_config/collar/cross
	name = "Cross Collar"
	json_config = 'packages/greyscale/json_configs/collar/cross.json'

/datum/greyscale_config/collar/cross/worn
	name = "Cross Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/cross_worn.json'

// Holo
/datum/greyscale_config/collar/holo
	name = "Holo Collar"
	json_config = 'packages/greyscale/json_configs/collar/holo.json'

/datum/greyscale_config/collar/holo/worn
	name = "Holo Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/holo_worn.json'

// Leather
/datum/greyscale_config/collar/leather
	name = "Leather Collar"
	json_config = 'packages/greyscale/json_configs/collar/leather.json'

/datum/greyscale_config/collar/leather/worn
	name = "Leather Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/leather_worn.json'

// Pet
/datum/greyscale_config/collar/pet
	name = "Pet Collar"
	json_config = 'packages/greyscale/json_configs/collar/pet.json'

/datum/greyscale_config/collar/pet/worn
	name = "Pet Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/pet_worn.json'

// Spiked
/datum/greyscale_config/collar/spike
	name = "Spiked Collar"
	json_config = 'packages/greyscale/json_configs/collar/spike.json'

/datum/greyscale_config/collar/spike/worn
	name = "Spiked Collar (Worn)"
	json_config = 'packages/greyscale/json_configs/collar/spike_worn.json'
...
/datum/greyscale_config/apron
	name = "Apron"
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/suits/apron/apron.json'

/datum/greyscale_config/apron/worn
	name = "Apron (Worn)"
	json_config = 'packages/greyscale/json_configs/suits/apron/apron_worn.json'

/datum/greyscale_config/apron/worn/teshari
	icon_file = 'packages/greyscale/assets/suit/suit_teshari.dmi'

/datum/greyscale_config/apron/worn/newvox
	icon_file = 'packages/greyscale/assets/suit/suit_newvox.dmi'

/datum/greyscale_config/apron/worn/oldvox
	icon_file = 'packages/greyscale/assets/suit/suit_oldvox.dmi'

// ARMOR

/datum/greyscale_config/heck_suit/worn/digi
	icon_file = 'packages/clothing/assets/mob/suit_digi.dmi'

//Helmet pairs with the above suit
/datum/greyscale_config/heck_helmet/worn/snouted
	icon_file = 'packages/clothing/assets/mob/head/helmet_muzzled.dmi'
...
/datum/greyscale_config/bathrobe
	name = "Bathrobe"
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/suits/bathrobe/bathrobe.json'

/datum/greyscale_config/bathrobe/worn
	name = "Worn Bathrobe"
	json_config = 'packages/greyscale/json_configs/suits/bathrobe/bathrobe_worn.json'
...
/datum/greyscale_config/fancy_suit
	name = "Fancy Suit"
	icon_file = 'packages/greyscale/assets/fancy_suits.dmi'
	json_config = 'packages/greyscale/json_configs/fancy_suits/fancy_suit.json'

/datum/greyscale_config/fancy_suit/worn
	name = "Worn Fancy Suit"
	json_config = 'packages/greyscale/json_configs/fancy_suits/fancy_suit_worn.json'

/datum/greyscale_config/recolorable_suit
	name = "Formal Suit"
	icon_file = 'packages/clothing/assets/obj/under/suits.dmi'
	json_config = 'packages/greyscale/json_configs/fancy_suits/recolorable_suit.json'

/datum/greyscale_config/recolorable_suit/worn
	name = "Worn Formal Suit"
	icon_file = 'packages/clothing/assets/mob/under/suits.dmi'

/datum/greyscale_config/recolorable_suit/worn/digi
	name = "Worn Formal Suit - Digitigrade"
	icon_file = 'packages/clothing/assets/mob/under/suits_digi.dmi'
...
/datum/greyscale_config/hoodie
	name = "Hoodie"
	icon_file = 'packages/greyscale/assets/hoodie.dmi'
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie.json'

/datum/greyscale_config/hoodie/worn
	name = "Hoodie Worn"
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie_worn.json'

/datum/greyscale_config/hoodie_trim
	name = "Trimmed Hoodie"
	icon_file = 'packages/greyscale/assets/hoodie.dmi'
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie_trim.json'

/datum/greyscale_config/hoodie_trim/worn
	name = "Trimmed Hoodie Worn"
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie_trim_worn.json'

/datum/greyscale_config/hoodie_branded
	name = "Branded Hoodie"
	icon_file = 'packages/greyscale/assets/hoodie.dmi'
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie_branded.json'

/datum/greyscale_config/hoodie_branded/worn
	name = "Branded Hoodie Worn"
	json_config = 'packages/greyscale/json_configs/hoodie/hoodie_branded_worn.json'

// CARDIGAN

/datum/greyscale_config/cardigan
	name = "Cardigan"
	icon_file = 'packages/greyscale/assets/suit.dmi'
	json_config = 'packages/greyscale/json_configs/cardigan/cardigan.json'

/datum/greyscale_config/cardigan/worn
	name = "Cardigan (Worn)"
	json_config = 'packages/greyscale/json_configs/cardigan/cardigan_worn.json'

// SWEATERS

/datum/greyscale_config/cableknit_sweater
	name = "Cableknit Sweater"
	icon_file = 'packages/greyscale/assets/sweaters.dmi'
	json_config = 'packages/greyscale/json_configs/sweater/sweater.json'

/datum/greyscale_config/cableknit_sweater/worn
	name = "Cableknit Sweater (Worn)"
	json_config = 'packages/greyscale/json_configs/sweater/sweater_worn.json'
...
/datum/greyscale_config/overalls
	name = "Overalls"
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/overalls/overalls.json'

/datum/greyscale_config/overalls/worn
	name = "Worn Overalls"
	json_config = 'packages/greyscale/json_configs/overalls/overalls_worn.json'

/datum/greyscale_config/overalls/worn/digi
	name = "Worn Overalls - Digitigrade"
	icon_file = 'packages/greyscale/assets/suit/suit_digi.dmi'

// URBAN COAT

/datum/greyscale_config/urban_coat
	name = "Urban Coat"
	icon_file = 'packages/greyscale/assets/urban_coat.dmi'
	json_config = 'packages/greyscale/json_configs/urban_coat/urban_coat.json'

/datum/greyscale_config/urban_coat/worn
	name = "Urban Coat (Worn)"
	json_config = 'packages/greyscale/json_configs/urban_coat/urban_coat_worn.json'

// LEATHER JACKET

/datum/greyscale_config/leather_jacket
	name = "Leather Jacket"
	icon_file = 'packages/greyscale/assets/leather_jacket.dmi'
	json_config = 'packages/greyscale/json_configs/leather_jacket/leather_jacket.json'

/datum/greyscale_config/leather_jacket/worn
	name = "Leather Jacket (Worn)"
	json_config = 'packages/greyscale/json_configs/leather_jacket/leather_jacket_worn.json'

// DUSTER

/datum/greyscale_config/duster
	name = "Duster"
	icon_file = 'packages/greyscale/assets/duster.dmi'
	json_config = 'packages/greyscale/json_configs/duster/duster.json'

/datum/greyscale_config/duster/worn
	name = "Duster (Worn)"
	json_config = 'packages/greyscale/json_configs/duster/duster_worn.json'

// PEACOAT

/datum/greyscale_config/peacoat
	name = "Peacoat"
	icon_file = 'packages/greyscale/assets/peacoat.dmi'
	json_config = 'packages/greyscale/json_configs/peacoat/peacoat.json'
...
/datum/greyscale_config/varsity
	name = "Varsity Jacket"
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/suits/varsity/varsity.json'

/datum/greyscale_config/varsity/worn
	name = "Varsity Jacket (Worn)"
	json_config = 'packages/greyscale/json_configs/suits/varsity/varsity_worn.json'
...
/datum/greyscale_config/tailored_jacket
	...
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/suits/tailored_jacket/tailored_jacket.json'

/datum/greyscale_config/tailored_jacket/worn
	name = "Tailored Jacket (Worn)"
	json_config = 'packages/greyscale/json_configs/suits/tailored_jacket/tailored_jacket_worn.json'

/datum/greyscale_config/tailored_short_jacket
	name = "Tailored Short Jacket"
	icon_file = 'packages/greyscale/assets/suit/suit.dmi'
	json_config = 'packages/greyscale/json_configs/suits/tailored_short_jacket/tailored_short_jacket.json'

/datum/greyscale_config/tailored_short_jacket/worn
	name = "Tailored Short Jacket (Worn)"
	json_config = 'packages/greyscale/json_configs/suits/tailored_short_jacket/tailored_short_jacket_worn.json'
...
/datum/greyscale_config/jumpsuit_worn/digi
	...
	icon_file = 'packages/clothing/assets/mob/under/color_digi.dmi'
...
/datum/greyscale_config/jumpsuit_worn/monkey
	...
	json_config = 'packages/greyscale/json_configs/jumpsuit/jumpsuit_worn_monkey.json'

/datum/greyscale_config/jumpsuit_prison_worn/monkey
	name = "Worn Prison Jumpsuit - Monkey"
	icon_file = MONKEY_UNIFORM_FILE
	json_config = 'packages/greyscale/json_configs/jumpsuit/jumpsuit_prison_worn_monkey.json'

/datum/greyscale_config/jumpsuit_worn/vox
	name = "Worn Jumpsuit - Vox"
	icon_file = 'packages/greyscale/assets/jumpsuit_vox.dmi'
...
/datum/greyscale_config/jumpsuit_worn/better_vox
	...
	icon_file = 'packages/greyscale/assets/jumpsuit_better_vox.dmi'
...
/datum/greyscale_config/jumpsuit_worn/taur/snake
	...
	icon_file = 'packages/greyscale/assets/jumpsuit_snake.dmi'
...
/datum/greyscale_config/jumpsuit_worn/teshari
	...
	icon_file = 'packages/greyscale/assets/jumpsuit_teshari.dmi'
...
/datum/greyscale_config/shorts_ripped
	name = "Ripped Shorts"
	icon_file = 'packages/clothing/assets/obj/under/shorts_pants_shirts.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/shorts_ripped.json'
...
/datum/greyscale_config/shorts_ripped/worn //TG will hopefully start having worn as a subtype, it means only needing 1 .json
	...
	icon_file = 'packages/clothing/assets/mob/under/shorts_pants_shirts.dmi'
...
/datum/greyscale_config/shorts_ripped/worn/teshari
	...
	icon_file = 'packages/greyscale/assets/teshari_uniform.dmi'

/datum/greyscale_config/jeans_ripped
	name = "Ripped Jeans"
	icon_file = 'packages/clothing/assets/obj/under/shorts_pants_shirts.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/jeans_ripped.json'
...
/datum/greyscale_config/yoga_pants
	name = "Yoga Pants"
	icon_file = 'packages/clothing/assets/obj/under/shorts_pants_shirts.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/yoga_pants.json'
...
/datum/greyscale_config/lone_skirt
	name = "Skirt"
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/lone_skirt.json'

/datum/greyscale_config/lone_skirt/worn
	name = "Worn Skirt"
	icon_file = 'packages/clothing/assets/mob/under/skirts_dresses.dmi'

/datum/greyscale_config/turtleskirt_knit
	name = "Cableknit Skirtleneck"
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/turtleskirt_knit.json'
...
/datum/greyscale_config/jean_skirt
	name = "Jean Skirt"
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/jean_skirt.json'
...
/datum/greyscale_config/short_dress
	name = "Short Dress"
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/short_dress.json'
...
/datum/greyscale_config/strapless_dress
	...
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/strapless_dress.json'
...
/datum/greyscale_config/pentagram_dress
	...
	icon_file = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	json_config = 'packages/greyscale/json_configs/pants_shorts_skirts_dresses/pentagram_dress.json'
...
/datum/greyscale_config/plaidskirt_worn/teshari
	...
	icon_file = 'packages/greyscale/assets/dressteshari.dmi'
...
/datum/greyscale_config/football_suit_worn/digi
	icon_file = 'packages/clothing/assets/mob/under/costume_digi.dmi'

/datum/greyscale_config/qipao
	name = "Qipao"
	icon_file = 'packages/clothing/assets/obj/under/costume.dmi'
	json_config = 'packages/greyscale/json_configs/costumes/lunar_japanese.json'

/datum/greyscale_config/qipao/worn
	name = "Worn Qipao"
	icon_file = 'packages/clothing/assets/mob/under/costume.dmi'
...
/datum/greyscale_config/kilt
	name = "Kilt"
	icon_file = 'packages/clothing/assets/obj/under/shorts_pants_shirts.dmi'
	json_config = 'packages/greyscale/json_configs/kilt/kilt.json'
...
/datum/greyscale_config/buttondown_vicvest
	...
	icon_file = 'packages/clothing/assets/obj/under/shorts_pants_shirts.dmi'
	json_config = 'packages/greyscale/json_configs/costumes/buttondown_vicvest.json'
...
/datum/greyscale_config/trek/worn/digi
	...
	icon_file = 'packages/clothing/assets/mob/under/trek_digi.dmi'
...
/datum/greyscale_config/sneakers_worn/digi
	...
	icon_file = 'packages/greyscale/assets/sneakers_digi.dmi'
...
/datum/greyscale_config/sneakers_worn/vox
	...
	icon_file = 'packages/greyscale/assets/sneakers_vox.dmi'
...
/datum/greyscale_config/boots
	...
	icon_file = 'packages/greyscale/assets/shoes/shoes.dmi'
	json_config = 'packages/greyscale/json_configs/shoes/boots/boots.json'

/datum/greyscale_config/boots/worn
	name = "Colorable Boots (Worn)"
	json_config = 'packages/greyscale/json_configs/shoes/boots/boots_worn.json'

/datum/greyscale_config/boots/worn/digi
	icon_file = 'packages/greyscale/assets/shoes/shoes_digi.dmi'

/datum/greyscale_config/boots/worn/teshari
	icon_file = 'packages/greyscale/assets/shoes/shoes_teshari.dmi'

/datum/greyscale_config/boots/worn/newvox
	icon_file = 'packages/greyscale/assets/shoes/shoes_newvox.dmi'

/datum/greyscale_config/boots/worn/oldvox
	icon_file = 'packages/greyscale/assets/shoes/shoes_oldvox.dmi'
...
/datum/greyscale_config/laceup
	...
	icon_file = 'packages/greyscale/assets/shoes/shoes.dmi'
	json_config = 'packages/greyscale/json_configs/shoes/laceups/laceups.json'

/datum/greyscale_config/laceup/worn
	name = "Colorable Laceups (Worn)"
	json_config = 'packages/greyscale/json_configs/shoes/laceups/laceups_worn.json'
...
/datum/greyscale_config/sandals
	...
	icon_file = 'packages/greyscale/assets/shoes/shoes.dmi'
	json_config = 'packages/greyscale/json_configs/shoes/sandals/sandals.json'

/datum/greyscale_config/sandals/worn
	name = "Colorable Sandals (Worn)"
	json_config = 'packages/greyscale/json_configs/shoes/sandals/sandals_worn.json'
...
/datum/greyscale_config/wraps
	name = "Cloth Wraps"
	icon_file = 'packages/greyscale/assets/shoes.dmi'
	json_config = 'packages/greyscale/json_configs/wraps/wraps.json'

/datum/greyscale_config/wraps/worn
	name = "Cloth Wraps (Worn)"
	json_config = 'packages/greyscale/json_configs/wraps/wraps_worn.json'
...
/datum/greyscale_config/heels
	name = "High Heels"
	icon_file = 'packages/greyscale/assets/heels.dmi'
	json_config = 'packages/greyscale/json_configs/shoes/heels/heels.json'

/datum/greyscale_config/heels/worn
	name = "High Heels (Worn)"
	json_config = 'packages/greyscale/json_configs/shoes/heels/heels_worn.json'

/datum/greyscale_config/heels/worn/digi
	name = "High Heels (Worn Digi)"
	json_config = 'packages/greyscale/json_configs/shoes/heels/heels_worn_digi.json'

/datum/greyscale_config/fancyheels
	name = "Fancy Heels"
	icon_file = 'packages/greyscale/assets/fancyheels.dmi'
	json_config = 'packages/greyscale/json_configs/shoes/fancyheels/fancyheels.json'

/datum/greyscale_config/fancyheels/worn
	name = "Fancy Heels (Worn)"
	json_config = 'packages/greyscale/json_configs/shoes/fancyheels/fancyheels_worn.json'

/datum/greyscale_config/fancyheels/worn/digi
	name = "Fancy Heels (Worn Digi)"
	json_config = 'packages/greyscale/json_configs/shoes/fancyheels/fancyheels_worn_digi.json'

// TESHARI FALLBACKS.

/datum/greyscale_config/teshari
	name = "Teshari Clothing"
	icon_file = 'packages/greyscale/assets/teshari_fallbacks.dmi'
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/under.json'
...
/datum/greyscale_config/teshari/under_skirt
	name = "Teshari Skirt"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/under_skirt.json'

/datum/greyscale_config/teshari/shoes
	name = "Teshari Shoes"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/shoes.json'

/datum/greyscale_config/teshari/gloves
	name = "Teshari Gloves"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/gloves.json'

/datum/greyscale_config/teshari/glasses
	name = "Teshari Glasses"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/glasses.json'

/datum/greyscale_config/teshari/coat
	name = "Teshari Coat"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/coat.json'

/datum/greyscale_config/teshari/armor
	name = "Teshari Armor"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/armor.json'

/datum/greyscale_config/teshari/backpack
	name = "Teshari Backpack"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/backpack.json'

/datum/greyscale_config/teshari/spacesuit
	name = "Teshari Spacesuit"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/spacesuit.json'

/datum/greyscale_config/teshari/cloak
	name = "Teshari Cloak"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/cloak.json'

/datum/greyscale_config/teshari/tie
	name = "Teshari Tie"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/tie.json'

/datum/greyscale_config/teshari/scarf
	name = "Teshari Scarf"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/scarf.json'

/datum/greyscale_config/teshari/modcontrol
	name = "Teshari Modsuit"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/modcontrol.json'

/datum/greyscale_config/teshari/hardsuit
	name = "Teshari Hardsuit"
	json_config = 'packages/greyscale/json_configs/teshari_fallbacks/hardsuit.json'
...
/datum/greyscale_config/id_card
	...
	icon_file = 'packages/greyscale/assets/id_card.dmi'
	json_config = 'packages/greyscale/json_configs/items/id_card.json'
