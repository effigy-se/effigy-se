...
/obj/item/clothing/suit/hooded/wintercoat/skyrat
	...
	icon = 'packages/_overrides/icons/obj/clothing/suits/wintercoat.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/suits/wintercoat.dmi'
...
/obj/item/clothing/head/hooded/winterhood/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/head/winterhood.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/head/winterhood.dmi'
