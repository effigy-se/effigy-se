...
/obj/item/clothing/under/misc
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/misc_digi.dmi'

/obj/item/clothing/under/misc/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/misc.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/misc.dmi'
	can_adjust = FALSE
