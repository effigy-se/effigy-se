...
/obj/item/clothing/under/suit
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/suits_digi.dmi' //Anything that was in TG's suits.dmi, should be in our suits_digi.dmi

/obj/item/clothing/under/suit/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/suits.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/suits.dmi'
