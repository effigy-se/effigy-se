/obj/item/clothing/under/rank/security
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/security_digi.dmi' // Anything that was in the security.dmi, should be in the security_digi.dmi
