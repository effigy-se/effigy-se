/obj/item/clothing/under/rank/rnd
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/rnd_digi.dmi'	// Anything that was in the rnd.dmi, should be in the rnd_digi.dmi

/obj/item/clothing/under/rank/rnd/scientist/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/rnd.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/rnd.dmi'
