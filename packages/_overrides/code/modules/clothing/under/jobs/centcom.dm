...
/obj/item/clothing/under/rank/centcom
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/centcom_digi.dmi'	// Anything that was in the rnd.dmi, should be in the rnd_digi.dmi

/obj/item/clothing/under/rank/centcom/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/centcom.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/centcom.dmi'
