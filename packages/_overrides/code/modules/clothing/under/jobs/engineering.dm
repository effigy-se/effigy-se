/obj/item/clothing/under/rank/engineering
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/engineering_digi.dmi' // Anything that was in the engineering.dmi, should be in the engineering_digi.dmi

/obj/item/clothing/under/rank/engineering/engineer/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/engineering.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/engineering.dmi'
