/obj/item/clothing/under/rank/cargo
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/cargo_digi.dmi' // Anything that was in the cargo.dmi, should be in the cargo_digi.dmi

/obj/item/clothing/under/rank/cargo/tech/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/cargo.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/cargo.dmi'
