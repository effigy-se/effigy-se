/obj/item/clothing/under/rank/medical
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/medical_digi.dmi'	// Anything that was in the medical.dmi, should be in the medical_digi.dmi

/obj/item/clothing/under/rank/medical/doctor/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/medical.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/medical.dmi'
