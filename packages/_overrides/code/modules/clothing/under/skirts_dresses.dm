#define SKIRTS_DRESSES_DIGIFILE 'packages/_overrides/icons/mob/clothing/under/skirts_dresses_digi.dmi'
...
/obj/item/clothing/under/dress/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/skirts_dresses.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/skirts_dresses.dmi'
