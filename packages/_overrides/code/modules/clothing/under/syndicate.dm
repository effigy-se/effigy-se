...
/obj/item/clothing/under/syndicate
	worn_icon_digi = 'packages/_overrides/icons/mob/clothing/under/syndicate_digi.dmi' // Anything that was in the syndicate.dmi, should be in the syndicate_digi.dmi


/obj/item/clothing/under/syndicate/skyrat
	icon = 'packages/_overrides/icons/obj/clothing/under/syndicate.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/syndicate.dmi'
...
/obj/item/clothing/under/syndicate/tacticool //Overwrites the 'fake' one. Zero armor, sensors, and default blue. More Balanced to make station-available.
	...
	icon = 'packages/_overrides/icons/obj/clothing/under/syndicate.dmi' //Since its an overwrite it needs new icon linking. Woe.
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/syndicate.dmi'
