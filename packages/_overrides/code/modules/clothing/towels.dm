...
#define TOWEL_OBJ_ICON 'packages/_overrides/icons/obj/clothing/towel.dmi'
/// Icon path to the worn icon of the towel.
#define TOWEL_WORN_ICON 'packages/_overrides/icons/mob/clothing/towel.dmi'
/// Icon path to the worn icon of the towel for digitigrades.
#define TOWEL_WORN_ICON_DIGI 'packages/_overrides/icons/mob/clothing/towel_digi.dmi'
