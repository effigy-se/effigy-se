...
/// PORTER'S NOTE: I genuinely don't get why this is a thing. None of the NIF Programs genuinely offer any advantage asides from sprite size changing? And by the point you can use it on the target,
/// That doesn't matter anyways. The traitor version feels /especially/ useless. This is dumb, but I'm porting 1:1, so... here it is anyways!
