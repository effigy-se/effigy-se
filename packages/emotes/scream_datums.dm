...
/datum/scream_type/human
	name = "Human Scream"
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_m1.ogg', 'packages/emotes/assets/sound/voice/scream_m2.ogg')
	female_screamsounds = list('packages/emotes/assets/sound/voice/scream_f1.ogg', 'packages/emotes/assets/sound/voice/scream_f2.ogg')

/datum/scream_type/robotic
	name = "Robotic Scream"
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_silicon.ogg')
	female_screamsounds = null
...
/datum/scream_type/lizard2
	...
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_lizard.ogg')
	female_screamsounds = null

/datum/scream_type/moth
	name = "Moth Scream"
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_moth.ogg')
	female_screamsounds = null

/datum/scream_type/jelly
	name = "Jelly Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/jelly_scream.ogg')
	female_screamsounds = null

/datum/scream_type/vox
	name = "Vox Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/voxscream.ogg')
	female_screamsounds = null

/datum/scream_type/tajaran
	name = "Cat Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/cat_scream.ogg')
	female_screamsounds = null
...
/datum/scream_type/raptor //This is the Teshari scream ported from CitRP which was a cockatoo scream edited by BlackMajor.
	name = "Raptor Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/raptorscream.ogg')
	female_screamsounds = null

/datum/scream_type/rodent //Ported from Polaris/Virgo.
	name = "Rodent Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/rodentscream.ogg')
	female_screamsounds = null
...
/datum/scream_type/zombie
	name = "Zombie Scream"
	male_screamsounds = list('packages/emotes/assets/sound/emotes/zombie_scream.ogg')
	female_screamsounds = null
	donator_only = TRUE

/datum/scream_type/monkey
	name = "Monkey Scream"
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_monkey.ogg')
	female_screamsounds = null
	donator_only = TRUE
...
/datum/scream_type/skeleton
	...
	male_screamsounds = list('packages/emotes/assets/sound/voice/scream_skeleton.ogg')
	female_screamsounds = null
	donator_only = TRUE
