/mob/proc/manipulate_emotes()
	...
	// packages/emotes/emotes.dm
	var/static/list/effigy_living_emotes = list(
	...
	all_emotes += effigy_living_emotes
	...
	// packages/emotes/synth_emotes.dm
	...
	// packages/emotes/additionalemotes/overlay_emote.dm
	var/static/list/effigy_living_emotes_overlay = list(
	...
	all_emotes += effigy_living_emotes_overlay

	// packages/emotes/additionalemotes/turf_emote.dm
	...
	if(isbrain(src))
		...
		if(isliving(src))
			...
			available_emotes += effigy_living_emotes
			available_emotes += effigy_living_emotes_overlay
...
// packages/emotes/additionalemotes/synth_emotes.dm
