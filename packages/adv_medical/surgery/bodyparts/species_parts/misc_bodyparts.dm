...
/obj/item/bodypart/head/snail
	biological_state = BIO_FLESH //EFFIGY EDIT - Roundstart Snails - Now invertebrates!
...
/obj/item/bodypart/arm/left/snail
	...
	unarmed_damage_low = 1 //EFFIGY EDIT - Roundstart Snails - Lowest possible punch damage. if this is set to 0, punches will always miss.
	unarmed_damage_high = 5 //snails are soft and squishy //EFFIGY EDIT - Roundstart Snails - A Bit More Damage. Original = unarmed_damage_high = 0.5
