...
/obj/item/bodypart/head/proc/update_hair_and_lips()
	...
	hair_alpha = human_head_owner.hair_alpha ? human_head_owner.hair_alpha : owner_species.hair_alpha // EFFIGY EDIT - Customization - Hair alpha //hair_alpha = owner_species.hair_alpha // ORIGINAL
