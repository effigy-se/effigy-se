...
/obj/item/organ/external/spines
	...
	//dna_block = DNA_SPINES_BLOCK // EFFIGY EDIT REMOVAL - Customization - We have our own system to handle DNA.
...
/datum/bodypart_overlay/mutant/spines/get_global_feature_list()
	return GLOB.sprite_accessories["spines"] // EFFIGY EDIT - Customization - ORIGINAL: return GLOB.spines_list
