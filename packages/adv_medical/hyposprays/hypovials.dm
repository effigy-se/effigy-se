/obj/item/reagent_containers/cup/vial
	...
	icon = 'packages/adv_medical/assets/hypospray/vials.dmi'
	icon_state = "hypovial"
	spillable = FALSE
	volume = 10
...
/obj/item/reagent_containers/cup/vial/update_overlays()
	...
	if(reagents.total_volume)
		...
		switch(round((reagents.total_volume / volume)*100))
			...
			if(89 to 100)
				fill_overlay = 100
		var/mutable_appearance/filling = mutable_appearance('packages/adv_medical/assets/hypospray/hypospray_fillings.dmi', "[fill_name][fill_overlay]")
