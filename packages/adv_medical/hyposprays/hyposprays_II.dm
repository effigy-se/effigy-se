...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'packages/adv_medical/assets/hypospray/hyposprays.dmi'
...
/obj/item/hypospray/mkii/update_overlays()
	...
	if(!small_only)
		...
		vial_spritetype += "-s"
	var/mutable_appearance/chem_loaded = mutable_appearance('packages/adv_medical/assets/hypospray/hyposprays.dmi', vial_spritetype)
...
/obj/item/hypospray/mkii/afterattack(atom/target, mob/living/user, proximity)
	...
	playsound(loc, long_sound ? 'packages/adv_medical/assets/hypospray/hypospray_long.ogg' : pick('packages/adv_medical/assets/hypospray/hypospray.ogg','packages/adv_medical/assets/hypospray/hypospray2.ogg'), 50, 1, -1)
