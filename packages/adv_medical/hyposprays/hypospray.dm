...
/obj/item/hypospray/mkii/afterattack(atom/target, mob/living/user, proximity)
	...
	playsound(loc, long_sound ? 'packages/adv_medical/assets/obj/hypospray_long.ogg' : pick('packages/adv_medical/assets/obj/hypospray.ogg','packages/adv_medical/assets/obj/hypospray2.ogg'), 50, 1, -1)
