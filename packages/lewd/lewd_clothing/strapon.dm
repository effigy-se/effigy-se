...
/obj/item/clothing/strapon/proc/update_mob_action_buttonss()
	for(var/datum/action/item_action/take_strapon/action_button in actions_types)
		...
		action_button.button_icon = 'packages/lewd/assets/obj/lewd_items/lewd_items.dmi'
	update_icon()
			...
			if(BODY_ZONE_PRECISE_GROIN)
				if(vagina)
					if(hit_mob.is_bottomless() || vagina.visibility_preference == GENITAL_ALWAYS_SHOW)
						...
						playsound(loc, pick('packages/lewd/assets/sounds/bang1.ogg',
											'packages/lewd/assets/sounds/bang2.ogg',
											'packages/lewd/assets/sounds/bang3.ogg',
											'packages/lewd/assets/sounds/bang4.ogg',
											'packages/lewd/assets/sounds/bang5.ogg',
											'packages/lewd/assets/sounds/bang6.ogg'), 60, TRUE, ignore_walls = FALSE)
					else
			...
			if(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_PRECISE_EYES) //Mouth only. Sorry, perverts. No eye/ear penetration for you today.
				if(!hit_mob.is_mouth_covered())
					...
					playsound(loc, pick('packages/lewd/assets/sounds/bang1.ogg',
										...
										'packages/lewd/assets/sounds/bang4.ogg',
										'packages/lewd/assets/sounds/bang5.ogg',
										'packages/lewd/assets/sounds/bang6.ogg'), 40, TRUE, ignore_walls = FALSE)
				...
				if(hit_mob.is_bottomless())
					...
					playsound(loc, pick('packages/lewd/assets/sounds/bang1.ogg',
										...
										'packages/lewd/assets/sounds/bang4.ogg',
										'packages/lewd/assets/sounds/bang5.ogg',
										'packages/lewd/assets/sounds/bang6.ogg'), 100, TRUE, ignore_walls = FALSE)
