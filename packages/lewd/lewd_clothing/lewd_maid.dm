/obj/item/clothing/under/costume/lewdmaid
	...
	worn_icon_digi = 'packages/lewd/assets/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_snake = 'packages/lewd/assets/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_paw = 'packages/lewd/assets/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
	worn_icon_taur_hoof = 'packages/lewd/assets/mob/lewd_clothing/lewd_uniform/lewd_uniform.dmi'
...
/obj/item/clothing/under/costume/lewdmaid/attach_accessory(obj/item/attack_item)
	...
	accessory_overlay = mutable_appearance('packages/lewd/assets/mob/lewd_items/lewd_items.dmi', "[accessory_color]", ABOVE_MOB_LAYER + 0.1)
