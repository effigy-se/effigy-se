/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	worn_icon = 'packages/lewd/assets/mob/lewd_clothing/lewd_suit/sleepbag_normal.dmi'
	worn_icon_digi = 'packages/lewd/assets/mob/lewd_clothing/lewd_suit/sleepbag_digi.dmi'
	worn_icon_taur_snake = 'packages/lewd/assets/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_paw = 'packages/lewd/assets/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_hoof = 'packages/lewd/assets/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	...
	flags_inv = HIDEHEADGEAR|HIDENECK|HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT|HIDESUITSTORAGE|HIDEHAIR|HIDESEXTOY|HIDETAIL // EffigyEdit Add (#3 Customization - Ported from Skyrat) HIDETAIL
	strip_delay = 300
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/proc/fold(mob/user, src)
	bag_fold = !bag_fold
	playsound(user, 'packages/lewd/assets/sounds/latex.ogg', 40, TRUE, ignore_walls = FALSE)
	if(bag_fold == TRUE)
		w_class = WEIGHT_CLASS_SMALL
		slot_flags = NONE
	if(bag_fold == FALSE)
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/process(seconds_per_tick)
	if(time_to_sound_left <= 0)
		if(tt <= 0)
			playsound(loc, 'packages/lewd/assets/sounds/latex.ogg', 100, TRUE, ignore_walls = FALSE)
