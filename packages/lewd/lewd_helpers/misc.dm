...
/datum/looping_sound/vibrator
	start_sound = 'packages/lewd/assets/sounds/bzzz-loop-1.ogg'
	start_length = 1
	mid_sounds = 'packages/lewd/assets/sounds/bzzz-loop-1.ogg'
	mid_length = 1
	end_sound = 'packages/lewd/assets/sounds/bzzz-loop-1.ogg'
	falloff_distance = 1
	falloff_exponent = 5
