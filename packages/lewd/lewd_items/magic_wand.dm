...
/obj/item/clothing/sextoy/magic_wand/Initialize(mapload)
	...
	magicwand_overlay = mutable_appearance('packages/lewd/assets/mob/lewd_items/lewd_items.dmi', "magicwand", ABOVE_MOB_LAYER + 0.1) //two arguments
...
/obj/item/clothing/sextoy/magic_wand/attack(mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	playsound(loc, 'packages/lewd/assets/sounds/vibrate.ogg', (vibration_mode == "low" ? 10 : (vibration_mode == "hard" ? 30 : 20)), TRUE, ignore_walls = FALSE)
