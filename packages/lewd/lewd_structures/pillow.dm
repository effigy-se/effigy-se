...
/obj/effect/temp_visual/feathers
	name = "feathers"
	icon_state = "feathers"
	icon = 'packages/lewd/assets/obj/lewd_decals/lewd_decals.dmi'
	duration = 14
...
//and there is code for successful check, so we are hitting someone with a pillow
	...
	switch(user.zone_selected) //to let code know what part of body we gonna hit
		...
		if(BODY_ZONE_HEAD)
			...
			playsound(loc, 'packages/lewd/assets/sounds/hug.ogg', 50, 1, -1)
...
/obj/structure/bed/pillow_tiny
	...
	icon = 'packages/lewd/assets/obj/lewd_structures/pillows.dmi'
	icon_state = "pillow_pink_round"
	base_icon_state = "pillow"
	var/current_color = "pink"
	var/current_form = "round"
...
/obj/structure/chair/pillow_small/proc/GetArmrest()
	if(current_color == "pink")
		return mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_small_pink_overlay")
	if(current_color == "teal")
		return mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_small_teal_overlay")
...
/obj/structure/chair/pillow_small/update_overlays()
	. = ..()
	if(has_buckled_mobs())
		. += mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_small_[current_color]_overlay", layer = ABOVE_MOB_LAYER + 0.2)
...
/obj/structure/bed/pillow_large/proc/GetArmrest()
	if(current_color == "pink")
		return mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_large_pink_overlay")
	if(current_color == "teal")
		return mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_large_teal_overlay")
...
/obj/structure/bed/pillow_large/update_overlays()
	. = ..()
	if(has_buckled_mobs())
		. += mutable_appearance('packages/lewd/assets/obj/lewd_structures/pillows.dmi', "pillowpile_large_[current_color]_overlay", layer = ABOVE_MOB_LAYER + 0.2)
