/obj/structure/chair/shibari_stand
	...
	icon = 'packages/lewd/assets/obj/lewd_structures/shibari_stand.dmi'
	...
	var/static/mutable_appearance/shibari_shadow_overlay = mutable_appearance('packages/lewd/assets/obj/lewd_structures/shibari_stand.dmi', "shibari_shadow", LOW_OBJ_LAYER)
