...
/obj/structure/bed/bdsm_bed
	...
	icon = 'packages/lewd/assets/obj/lewd_structures/bdsm_furniture.dmi'
	icon_state = "bdsm_bed"
	max_integrity = 50
...
/obj/structure/chair/x_stand
	...
	var/static/mutable_appearance/xstand_overlay = mutable_appearance('packages/lewd/assets/obj/lewd_structures/bdsm_furniture.dmi', "xstand_overlay", LYING_MOB_LAYER)
