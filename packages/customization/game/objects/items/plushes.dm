...
/obj/item/toy/plush/skyrat/borbplushie
	...
	squeak_override = list('packages/emotes/assets/sound/voice/peep_once.ogg' = 1)
...
/obj/item/toy/plush/skyrat/duffmoth
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/mothsqueak.ogg'= 1)
	gender = MALE
...
/obj/item/toy/plush/skyrat/leaplush
	...
	squeak_override = list('packages/customization/game/objects/items/sound/leaplush.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/skyrat/sarmieplush
	...
	squeak_override = list('packages/emotes/assets/sound/voice/weh.ogg' = 1)
	gender = MALE
...
/obj/item/toy/plush/skyrat/sharknet
	...
	squeak_override = list('packages/emotes/assets/sound/voice/slime_squish.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/skyrat/szaplush
	...
	squeak_override = list('packages/customization/game/objects/items/sound/spiderplush.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/skyrat/ian
	...
	squeak_override = list('packages/emotes/assets/sound/voice/bark2.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/skyrat/seaduplush
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/synth_yes.ogg' = 1,'packages/emotes/assets/sound/emotes/synth_no.ogg' = 1)
...
/obj/item/toy/plush/skyrat/tribal_salamander
	...
	squeak_override = list('packages/emotes/assets/sound/voice/wurble.ogg' = 1)
...
/obj/item/toy/plush/skyrat/skreking_vox
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/voxrustle.ogg' = 1)
...
/obj/item/toy/plush/skyrat/blue_cat
	...
	squeak_override = list('packages/emotes/assets/sound/voice/nya.ogg' = 1)
...
/obj/item/toy/plush/skyrat/igneous_synth
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/twobeep.ogg' = 1)
...
/obj/item/toy/plush/skyrat/edgy_bird
	...
	squeak_override = list('packages/emotes/assets/sound/voice/caw.ogg' = 1)
...
/obj/item/toy/plush/skyrat/fox/kailyn
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/female/female_sneeze.ogg' = 1)
...
/obj/item/toy/plush/skyrat/xixi
	...
	squeak_override = list('packages/emotes/assets/sound/voice/peep_once.ogg' = 1,'packages/emotes/assets/sound/voice/caw.ogg' = 1,'packages/emotes/assets/sound/voice/bawk.ogg' = 1,'packages/emotes/assets/sound/emotes/voxscream.ogg' = 1)
...
/obj/item/toy/plush/skyrat/roselia
	...
	attack_verb_continuous = list("hugs")
	attack_verb_simple = list("hug")
	squeak_override = list('packages/emotes/assets/sound/voice/merp.ogg' = 1)
	young = FALSE
...
/obj/item/toy/plush/skyrat/chunko/bonnie
	...
	squeak_override = list('sound/effects/mousesqueek.ogg' = 1, 'packages/emotes/assets/sound/voice/mothsqueak.ogg' = 1,)
...
/obj/item/toy/plush/skyrat/chunko/inessa
	...
	squeak_override = list('packages/emotes/assets/sound/emotes/female/female_cough_3.ogg' = 1, 'packages/emotes/assets/sound/emotes/female/female_cough_2.ogg' = 1, 'packages/emotes/assets/sound/emotes/female/female_cough_1.ogg' = 1)
...
/obj/item/toy/plush/skyrat/plushie_star
	...
	gender = FEMALE
	squeak_override = list('packages/emotes/assets/sound/voice/trills.ogg' = 1)
...
/obj/item/toy/plush/skyrat/snow_owl
	...
	squeak_override = list('packages/emotes/assets/sound/voice/hoot.ogg' = 1)
...
/obj/item/toy/plush/skyrat/tracy
	...
	squeak_override = list('packages/customization/game/objects/items/sound/tracymrowr.ogg' = 1)
	gender = FEMALE
