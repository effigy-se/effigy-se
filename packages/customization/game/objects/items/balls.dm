/obj/item/toy/tennis
	...
	icon = 'overrides/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	lefthand_file = 'overrides/icons/mob/inhands/balls_left.dmi'
	righthand_file = 'overrides/icons/mob/inhands/balls_right.dmi'
	inhand_icon_state = "tennis_classic"
	worn_icon = 'overrides/icons/mob/mouthball.dmi'
