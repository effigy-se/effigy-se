/obj/item/toy/tennis
	...
	icon = 'packages/_overrides/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	lefthand_file = 'packages/_overrides/icons/mob/inhands/balls_left.dmi'
	righthand_file = 'packages/_overrides/icons/mob/inhands/balls_right.dmi'
	inhand_icon_state = "tennis_classic"
	worn_icon = 'packages/_overrides/icons/mob/mouthball.dmi'
