...
/datum/sprite_accessory/snouts/synthliz
	...
	icon = 'packages/customization/assets/sprite_accessory/synthliz_snouts.dmi'
...
/datum/sprite_accessory/tails/synthliz
	recommended_species = list()
	icon = 'packages/customization/assets/sprite_accessory/synthliz_tails.dmi'
	color_src = USE_ONE_COLOR
...
/datum/sprite_accessory/antenna/synthliz
	icon = 'packages/customization/assets/sprite_accessory/synthliz_antennas.dmi'
	color_src = USE_ONE_COLOR
