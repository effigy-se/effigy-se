...
/datum/sprite_accessory/wings/mammal
	icon = 'packages/_overrides/icons/mob/sprite_accessory/wings.dmi'
...
/datum/sprite_accessory/wings/moth
	icon = 'packages/_overrides/icons/mob/sprite_accessory/moth_wings.dmi' // Needs new icon to suit new naming convention
	default_color = "#FFFFFF"
