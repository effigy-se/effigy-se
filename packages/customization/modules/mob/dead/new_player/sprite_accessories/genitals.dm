...
/datum/sprite_accessory/genital/penis
	icon = 'packages/_overrides/icons/mob/sprite_accessory/genitals/penis_onmob.dmi'
...
/datum/sprite_accessory/genital/penis/get_special_icon(mob/living/carbon/human/target_mob)
	...
	return 'packages/_overrides/icons/mob/sprite_accessory/genitals/taur_penis_onmob.dmi'
...
/datum/sprite_accessory/genital/testicles
	icon = 'packages/_overrides/icons/mob/sprite_accessory/genitals/testicles_onmob.dmi'
...
/datum/sprite_accessory/genital/vagina
	icon = 'packages/_overrides/icons/mob/sprite_accessory/genitals/vagina_onmob.dmi'
...
/datum/sprite_accessory/genital/breasts
	icon = 'packages/_overrides/icons/mob/sprite_accessory/genitals/breasts_onmob.dmi'
