/obj/item/clothing/head/costume/skyrat
	icon = 'overrides/icons/obj/clothing/head/costume.dmi'
	worn_icon = 'overrides/icons/mob/clothing/head/costume.dmi'
...
/obj/item/clothing/head/pelt/wolf
	...
	worn_icon = 'overrides/icons/mob/clothing/head/pelt_big.dmi'
