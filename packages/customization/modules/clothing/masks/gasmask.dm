...
/obj/item/clothing/mask/gas/hecu2
	...
	icon = 'packages/_overrides/icons/obj/clothing/masks.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/mask.dmi'
	worn_icon_teshari = 'packages/_overrides/icons/mob/clothing/species/teshari/mask.dmi'
	icon_state = "hecu2"
...
/obj/item/clothing/mask/gas/clown_hat/vox
	...
	icon = 'packages/_overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_better_vox = 'packages/_overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_vox = 'packages/_overrides/icons/mob/clothing/species/vox/mask.dmi'
...
/obj/item/clothing/mask/gas/mime/vox/ui_action_click(mob/user)
	...
	if(src && choice && !user.incapacitated() && in_range(user,src))
		...
		if(human_user.dna.species.mutant_bodyparts["snout"])
			icon = 'packages/_overrides/icons/obj/clothing/masks.dmi'
			worn_icon = 'packages/_overrides/icons/mob/clothing/mask_muzzled.dmi'
