...
/obj/item/clothing/mask/gas/hecu2
	...
	icon = 'overrides/icons/obj/clothing/masks.dmi'
	worn_icon = 'overrides/icons/mob/clothing/mask.dmi'
	worn_icon_teshari = 'overrides/icons/mob/clothing/species/teshari/mask.dmi'
	icon_state = "hecu2"
...
/obj/item/clothing/mask/gas/clown_hat/vox
	...
	icon = 'overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon = 'overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_better_vox = 'overrides/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_vox = 'overrides/icons/mob/clothing/species/vox/mask.dmi'
...
/obj/item/clothing/mask/gas/mime/vox/ui_action_click(mob/user)
	...
	if(src && choice && !user.incapacitated() && in_range(user,src))
		...
		if(human_user.dna.species.mutant_bodyparts["snout"])
			icon = 'overrides/icons/obj/clothing/masks.dmi'
			worn_icon = 'overrides/icons/mob/clothing/mask_muzzled.dmi'
