/obj/item/clothing/under/misc/bluetracksuit
	...
	icon = 'packages/_overrides/icons/obj/clothing/uniforms.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/uniform.dmi'
...
/obj/item/clothing/under/pants/tactical
	icon = 'packages/_overrides/icons/obj/clothing/under/shorts_pants_shirts.dmi'
	worn_icon = 'packages/_overrides/icons/mob/clothing/under/shorts_pants_shirts.dmi'
	name = "tactical pants"
