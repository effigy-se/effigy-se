...
GLOBAL_LIST_INIT(robotic_styles_list, list(
	...
	"Morpheus Cyberkinetics" = 'packages/_overrides/icons/mob/augmentation/mcgipc.dmi',
	"Bishop Cyberkinetics" = 'packages/_overrides/icons/mob/augmentation/bshipc.dmi',
	"Bishop Cyberkinetics 2.0" = 'packages/_overrides/icons/mob/augmentation/bs2ipc.dmi',
	"Hephaestus Industries" = 'packages/_overrides/icons/mob/augmentation/hsiipc.dmi',
	"Hephaestus Industries 2.0" = 'packages/_overrides/icons/mob/augmentation/hi2ipc.dmi',
	"Shellguard Munitions Standard Series" = 'packages/_overrides/icons/mob/augmentation/sgmipc.dmi',
	"Ward-Takahashi Manufacturing" = 'packages/_overrides/icons/mob/augmentation/wtmipc.dmi',
	"Xion Manufacturing Group" = 'packages/_overrides/icons/mob/augmentation/xmgipc.dmi',
	"Xion Manufacturing Group 2.0" = 'packages/_overrides/icons/mob/augmentation/xm2ipc.dmi',
	"Zeng-Hu Pharmaceuticals" = 'packages/_overrides/icons/mob/augmentation/zhpipc.dmi'
	))
