#define SKIRTS_DRESSES_DIGIFILE 'overrides/icons/mob/clothing/under/skirts_dresses_digi.dmi'
...
/obj/item/clothing/under/dress/skyrat
	icon = 'overrides/icons/obj/clothing/under/skirts_dresses.dmi'
	worn_icon = 'overrides/icons/mob/clothing/under/skirts_dresses.dmi'
