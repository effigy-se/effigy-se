#define SKIRTS_DRESSES_DIGIFILE 'packages/clothing/assets/mob/under/skirts_dresses_digi.dmi'
...
/obj/item/clothing/under/dress/skyrat
	icon = 'packages/clothing/assets/obj/under/skirts_dresses.dmi'
	worn_icon = 'packages/clothing/assets/mob/under/skirts_dresses.dmi'
