...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		//"TRAIT_NO_PLASMA_TRANSFORM" = TRAIT_NO_PLASMA_TRANSFORM, // EffigyTODO: transformation sting
		...
		//"TRAIT_STASIS" = TRAIT_STASIS, // EffigyTODO: transformation sting
		...
		//"TRAIT_UNHUSKABLE" = TRAIT_UNHUSKABLE, // EffigyTODO: transformation sting
