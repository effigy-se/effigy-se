...
/datum/unit_test/transformation_sting/proc/setup_ling()
	...
	ling.dna.mutant_bodyparts["tail"] = list(MUTANT_INDEX_NAME = "Smooth", MUTANT_INDEX_COLOR_LIST = list("#886600", "#886600", "#886600")) // EffigyEdit Change - Customization - Original: ling.dna.features["tail_lizard"] = "Smooth"
	ling.dna.mutant_bodyparts["snout"] = list(MUTANT_INDEX_NAME = "Sharp + Light", MUTANT_INDEX_COLOR_LIST = list("#886600", "#886600", "#886600")) // EffigyEdit Change - Customization - Original: ling.dna.features["snout"] = "Sharp + Light"
	ling.dna.mutant_bodyparts["horns"] = list(MUTANT_INDEX_NAME = "Curled", MUTANT_INDEX_COLOR_LIST = list("#292826", "#292826", "#8292826")) // EffigyEdit Change - Customization - Original: ling.dna.features["horns"] = "Curved"
	ling.dna.mutant_bodyparts["frills"] = list(MUTANT_INDEX_NAME = "Short", MUTANT_INDEX_COLOR_LIST = list("#886600", "#886600", "#886600")) // EffigyEdit Change - Customization - Original: ling.dna.features["frills"] = "Sort"
	ling.dna.mutant_bodyparts["spines"] = list(MUTANT_INDEX_NAME = "Long + Membrane", MUTANT_INDEX_COLOR_LIST = list("#886600", "#886600", "#886600")) // EffigyEdit Change - Customization - Original: ling.dna.features["spines"] = "Long + Membrane"
	ling.dna.body_markings["chest"] = list("Light Belly" = list("#886600", 0)) // EffigyEdit Change - Customization - Original: ling.dna.features["lizard_markings"] = list("Light Belly")
