...
/datum/unit_test/defined_inhand_icon_states
	...
	/// additional_inhands_location is for downstream modularity support. as an example, for skyrat's usage, set additional_inhands_location = "overrides/icons/mob/inhands/"
