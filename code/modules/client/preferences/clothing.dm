/proc/generate_values_for_underwear(list/accessory_list, list/icons, color, icon_offset) // EffigyEdit Change (#3 Customization - Ported from Skyrat)
	...
	for (var/accessory_name in accessory_list)
		...
		icon_with_socks.Crop(10, 1+icon_offset, 22, 13+icon_offset)	// EffigyEdit Change (#3 Customization - Ported from Skyrat)
