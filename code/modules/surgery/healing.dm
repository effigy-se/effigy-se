/datum/surgery/healing
	...
	requires_bodypart_type = BODYTYPE_ORGANIC // EFFIGY EDIT CHANGE (Was NONE)
...
/datum/surgery_step/heal/success(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	...
	if(user.mind && HAS_TRAIT(user.mind, TRAIT_MORBID) && ishuman(user) && !dead_patient) //Morbid folk don't care about tending the dead as much as tending the living
