...
/obj/item/organ/external/mob_insert(mob/living/carbon/receiver, special, movement_flags)
	...
	if(bodypart_overlay.imprint_on_next_insertion) //We only want this set *once*
		...
		if (isnull(feature_name))
			bodypart_overlay.set_appearance_from_dna(receiver.dna) // EffigyEdit Change - Original: feature_name = receiver.dna.species.external_organs[type]
...
/obj/item/organ/external/horns
	...
	//dna_block = DNA_HORNS_BLOCK // EffigyEdit Remove Customization
...
/datum/bodypart_overlay/mutant/horns/get_global_feature_list()
	return GLOB.sprite_accessories["horns"] // EffigyEdit Change Customization
...
/obj/item/organ/external/frills
	...
	//dna_block = DNA_FRILLS_BLOCK // EffigyEdit Remove Customization
...
/datum/bodypart_overlay/mutant/frills/get_global_feature_list()
	return GLOB.sprite_accessories["frills"] // EffigyEdit Change Customization

///Guess what part of the lizard this is?
/obj/item/organ/external/snout
	name = "snout" // EffigyEdit Change Customization ORIGINAL: name = "lizard snout"
	...
	//dna_block = DNA_SNOUT_BLOCK // EffigyEdit Remove Customization
	restyle_flags = EXTERNAL_RESTYLE_FLESH
...
/datum/bodypart_overlay/mutant/snout/get_global_feature_list()
	return GLOB.sprite_accessories["snout"] // EffigyEdit Change Customization ORIGINAL : return GLOB.snouts_list
...
/obj/item/organ/external/antennae
	...
	//dna_block = DNA_MOTH_ANTENNAE_BLOCK // EffigyEdit Remove Customization
	restyle_flags = EXTERNAL_RESTYLE_FLESH
...
/datum/bodypart_overlay/mutant/antennae/get_global_feature_list()
	return GLOB.sprite_accessories["moth_antennae"] // EffigyEdit Change Customization ORIGINAL: return GLOB.moth_antennae_list
