...
/obj/item/organ/external/wings/moth
	...
	//dna_block = DNA_MOTH_WINGS_BLOCK // EffigyEdit Change (#3 Customization - Ported from Skyrat)
...
/datum/bodypart_overlay/mutant/wings/moth
	feature_key = "wings" // EffigyEdit Remove (#3 Customization - Ported from Skyrat) ORIGINAL: feature_key = "moth_wings"
...
/datum/bodypart_overlay/mutant/wings/moth/get_global_feature_list()
	return GLOB.sprite_accessories["wings"] // EffigyEdit Remove (#3 Customization - Ported from Skyrat) ORIGINAL: return GLOB.moth_wings_list
