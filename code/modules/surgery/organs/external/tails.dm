...
/obj/item/organ/external/tail
	...
	//dna_block = DNA_TAIL_BLOCK // EFFIGY EDIT REMOVE - Customization - We have our own system to handle DNA.
...
/obj/item/organ/external/tail/proc/wag(mob/user, start = TRUE, stop_after = 0)
	...
	if(start)
		...
		stop_wag()
	owner.update_body() // EFFIGY EDIT CHANGE - Original: owner.update_body_parts()
...
/datum/bodypart_overlay/mutant/tail
	...
	feature_key = "tail" // EFFIGY EDIT CHANGE - Customization - ORIGINAL: feature_key = "tail_monkey"
	var/wagging = FALSE
...
/datum/bodypart_overlay/mutant/tail/get_global_feature_list()
	return GLOB.sprite_accessories["tail"] // EFFIGY EDIT CHANGE - Customization - ORIGINAL: return GLOB.tails_list
...
/datum/bodypart_overlay/mutant/tail/cat
	feature_key = "tail" // EFFIGY EDIT CHANGE - Customization - ORIGINAL: feature_key = "tail_cat"
	// color_source = ORGAN_COLOR_HAIR // EFFIGY EDIT REMOVE

/datum/bodypart_overlay/mutant/tail/cat/get_global_feature_list()
	return GLOB.sprite_accessories["tail"] // EFFIGY EDIT CHANGE - Customization - ORIGINAL: return GLOB.tails_list_human
...
/datum/bodypart_overlay/mutant/tail/lizard/get_global_feature_list()
	return GLOB.sprite_accessories["tail"] // EFFIGY EDIT CHANGE - Customization - ORIGINAL: return GLOB.tails_list_lizard
