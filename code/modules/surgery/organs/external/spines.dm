...
/obj/item/organ/external/spines
	...
	//dna_block = DNA_SPINES_BLOCK // EFFIGY EDIT REMOVE -  (#3 Customization - Ported from Skyrat)
...
/datum/bodypart_overlay/mutant/spines/get_global_feature_list()
	return GLOB.sprite_accessories["spines"] // EFFIGY EDIT CHANGE (#3 Customization - Ported from Skyrat) ORIGINAL: return GLOB.spines_list
