...
/datum/surgery_step/manipulate_organs/internal/can_use_organ(mob/user, obj/item/organ/organ)
	return isinternalorgan(organ) && !(organ.organ_flags & ORGAN_UNREMOVABLE) // EFFIGY EDIT - Don't show unremovable organs - ORIGINAL: return isinternalorgan(organ)
...
/datum/surgery_step/manipulate_organs/external/can_use_organ(mob/user, obj/item/organ/organ)
	return isexternalorgan(organ) && !(organ.organ_flags & ORGAN_UNREMOVABLE) // EFFIGY EDIT - Don't show unremovable organs - ORIGINAL: return isexternalorgan(organ)
