...
/mob/living/carbon/proc/enter_stamcrit()
	...
	if(getStaminaLoss() < MAX_HUMAN_STAMINA) // Puts you a little further into the initial stamcrit, makes stamcrit harder to outright counter with chems. // EffigyEdit Change
