...
/mob/living/carbon/human/update_worn_undersuit()
	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		// EFFIGY EDIT ADD START (#3 Customization - Ported from Skyrat) birbs
			...
			icon_file = generate_custom_worn_icon(LOADOUT_ITEM_UNIFORM, w_uniform, src)
...
/mob/living/carbon/human/update_worn_gloves()
	...
	if(gloves)
		...
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_GLOVES, gloves, src)
...
/mob/living/carbon/human/update_worn_glasses()
	...
	if(glasses)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_GLASSES, glasses, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
...
/mob/living/carbon/human/update_inv_ears()
	...
	if(ears)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_EARS, ears, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
		// EFFIGY EDIT ADD END (#3 Customization - Ported from Skyrat)
...
/mob/living/carbon/human/update_worn_neck()
	...
	if(wear_neck)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_NECK, wear_neck, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
		// EFFIGY EDIT ADD END (#3 Customization - Ported from Skyrat)
...
/mob/living/carbon/human/update_worn_shoes()
	...
	if(shoes)
		...
		if((bodytype & BODYTYPE_DIGITIGRADE) && (worn_item.supports_variations_flags & CLOTHING_DIGITIGRADE_VARIATION))
			...
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_SHOES, shoes, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
...
/mob/living/carbon/human/update_worn_head()
	...
	if(head)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_HEAD, head, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
...
/mob/living/carbon/human/update_worn_belt()
	...
	if(belt)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_BELT, belt, src)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
		// EFFIGY EDIT ADD END (#3 Customization - Ported from Skyrat)
...
/mob/living/carbon/human/update_worn_oversuit()
	...
	if(wear_suit)
		...
		// EFFIGY EDIT ADD START (#3 Customization - Ported from Skyrat)
			...
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_SUIT, wear_suit)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
		// EFFIGY EDIT ADD END (#3 Customization - Ported from Skyrat)
...
/mob/living/carbon/human/update_worn_mask()
	...
	if(wear_mask)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_MASK, wear_mask)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
...
/mob/living/carbon/human/update_worn_back()
	...
	if(back)
		...
		var/mutant_override = FALSE
		if(bodytype & BODYTYPE_CUSTOM)
			var/species_icon_file = generate_custom_worn_icon(LOADOUT_ITEM_MISC, back)
			if(species_icon_file)
				icon_file = species_icon_file
				mutant_override = TRUE
		// EFFIGY EDIT ADD END (#3 Customization - Ported from Skyrat)
