...
/obj/item/clothing/suit/armor/hos
	...
	unique_reskin = list(
		...
		"Navy Blue Jacket" = list(
			RESKIN_ICON = 'packages/clothing/assets/mob/obj/clothing/suits.dmi',
			RESKIN_ICON_STATE = "hosbluejacket",
			RESKIN_WORN_ICON = 'packages/clothing/assets/mob/clothing/suit.dmi',
			RESKIN_WORN_ICON_STATE = "hosbluejacket"
		),
		"Trenchcloak" = list(
			RESKIN_ICON = 'packages/clothing/assets/obj/clothing/suits.dmi',
