...
GLOBAL_LIST_INIT(leather_recipes, list ( \
	...
	new/datum/stack_recipe_list("belts", list( \
		...
		new/datum/stack_recipe("medical bandolier", /obj/item/storage/belt/medbandolier, 5, crafting_flags = NONE, category = CAT_CONTAINERS), \
		new/datum/stack_recipe("gear harness", /obj/item/clothing/under/misc/skyrat/gear_harness, 6, crafting_flags = NONE, category = CAT_CLOTHING), \
		// EffigyEdit End
	)),
