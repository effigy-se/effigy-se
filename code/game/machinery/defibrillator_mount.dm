...
/obj/machinery/defibrillator_mount/examine(mob/user)
	...
	if(defib)
		...
		if(SSsecurity_level.get_current_level_as_number() >= SEC_LEVEL_RED || SSsecurity_level.get_current_level_as_number() == SEC_LEVEL_VIOLET) // EffigyEdit Change - Alert levels
...
/obj/machinery/defibrillator_mount/attackby(obj/item/I, mob/living/user, params)
	...
	if(id)
		if(check_access(id) || SSsecurity_level.get_current_level_as_number() >= SEC_LEVEL_RED || SSsecurity_level.get_current_level_as_number() == SEC_LEVEL_VIOLET) //anyone can toggle the clamps in red alert! // EffigyEdit Change - Alert levels
			if(!defib)
