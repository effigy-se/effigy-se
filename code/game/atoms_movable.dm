/atom/movable
	...
	var/face_mouse = FALSE // EffigyEdit Add -  (#3 Customization - Ported from Skyrat)
...
/atom/movable/Move(atom/newloc, direct, glide_size_override = 0, update_dir = TRUE)
	...
	if(set_dir_on_move && dir != direct && update_dir) // EffigyTODO (#3 Customization - Ported from Skyrat)
		setDir(direct)
