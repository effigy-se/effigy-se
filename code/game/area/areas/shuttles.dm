...
/area/shuttle/arrival/on_joining_game(mob/living/boarder)
	if(SSshuttle.arrivals?.mode == SHUTTLE_CALL)
		...
		Spl.Fade(TRUE)
		boarder.playsound_local(get_turf(boarder), 'local/sound/jingles/LatejoinShuttle.ogg', 75) // EFFIGY EDIT - replaced `sound/voice/ApproachingTG.ogg`; upped volume from 25
