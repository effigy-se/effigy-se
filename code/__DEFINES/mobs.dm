...
//MINOR TWEAKS/MISC
#define AGE_MIN 18 //youngest a character can be // EffigyEdit Change (#3 Customization - Ported from Skyrat)
...
#define UNIFORM_LAYER 31 // EffigyEdit Change (#3 Customization - Ported from Skyrat) - ORIGINAL: 25
