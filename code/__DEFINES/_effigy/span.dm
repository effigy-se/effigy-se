...
#define span_boxannouncepink(str) ("<div class='efchatalert_3'><span class='boldannounce'>" + str + "</span></div>")
#define span_boxannouncegrey(str) ("<div class='efchatalert_2'><span class='boldannounce'>" + str + "</span></div>")
