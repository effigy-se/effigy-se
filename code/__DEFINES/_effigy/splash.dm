#define DEFAULT_TITLE_MAP_LOADTIME (60 SECONDS)

#define DEFAULT_TITLE_SCREEN_IMAGE 'local/icons/runtime/title-rainbow.png'
#define DEFAULT_TITLE_LOADING_SCREEN 'local/icons/runtime/title-rainbow.png'
