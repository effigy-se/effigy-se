/// This logs subtler emotes in game.txt if the conflig flag in config\effigy_config.txt is true.
...
/// This logs character creation if the conflig flag in config\effigy_config.txt is true.
