...
/proc/init_sprite_accessories()
	...
	*/
	...
	init_sprite_accessory_subtypes(/datum/sprite_accessory/wings/moth, GLOB.moth_wings_list) // EffigyEdit Add (#3 Customization - Ported from Skyrat)
	init_sprite_accessory_subtypes(/datum/sprite_accessory/pod_hair, GLOB.pod_hair_list, add_blank = TRUE) // EffigyEdit Change (#3 Customization - Ported from Skyrat)
...
/proc/make_datum_reference_lists()
	...
	make_extra_datum_references() // EffigyEdit Add (#3 Customization - Ported from Skyrat)
...
/proc/init_crafting_recipes(list/crafting_recipes)
	for(var/path in subtypesof(/datum/crafting_recipe))
		...
		var/is_cooking = ((recipe.category in GLOB.crafting_category_food) || (recipe.category in GLOB.crafting_category_food_extra)) // EffigyEdit Add (#3 Customization - Ported from Skyrat)
