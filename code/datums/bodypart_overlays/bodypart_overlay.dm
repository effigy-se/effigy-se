...
/datum/bodypart_overlay
	...
	var/static/list/all_layers = list(EXTERNAL_FRONT, EXTERNAL_ADJACENT, EXTERNAL_BEHIND, EXTERNAL_FRONT_UNDER_CLOTHES, EXTERNAL_FRONT_OVER) // EFFIGY EDIT CHANGE (#3 Customization - Ported from Skyrat)
