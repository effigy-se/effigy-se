...
/datum/id_trim/job/head_of_personnel
	...
	minimal_access = list(
		...
		ACCESS_SCIENCE,
		ACCESS_SERVICE,
		ACCESS_STUDIO_CONTROL, // EffigyEdit AddITION - BROADCAST TEAM
		ACCESS_TELEPORTER,
		ACCESS_THEATRE,
		ACCESS_WEAPONS,
	)
...
/datum/id_trim/job/security_officer/refresh_trim_access()
	...
	if(CONFIG_GET(number/depsec_access_level) == POPULATION_SCALED_ACCESS && CONFIG_GET(flag/allow_station_jobs))
