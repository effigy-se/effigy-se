...
/datum/radial_menu
	...
	var/icon_path = 'icons/hud/radial.dmi' // EFFIGY EDIT ADD (#3 Customization - Ported from Skyrat)
...
/datum/radial_menu/proc/setup_menu(use_tooltips, set_page = 1)
	...
	if(elements.len < max_elements)
		...
		for(var/i in 1 to elements_to_add) //Create all elements
			...
			new_element.icon = icon_path // EFFIGY EDIT ADD (#3 Customization - Ported from Skyrat)
