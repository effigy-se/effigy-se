...
code_files = glob.glob("code/**/*.dm", recursive=True) + glob.glob("packages/**/*.dm", recursive=True) + glob.glob("overrides/**/*.dm", recursive=True) # EffigyEdit Change
for code_file in code_files: # EffigyEdit Change
